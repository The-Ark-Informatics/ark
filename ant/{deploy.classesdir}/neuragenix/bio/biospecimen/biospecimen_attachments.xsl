...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	...
	<xsl:template match="biospecimenAttachments">
		...
		<xsl:variable name="strSampleType"><xsl:value-of select="/biospecimenAttachments/BIOSPECIMEN_strSampleType[@selected='1']"/></xsl:variable>
		
		<table width="100%">
			<tr>
				<td class="uportal-channel-subtitle"> Biospecimen Attachments </td>
		...
		<table width="100%">
			...
			<tr>
				...
				<td width="15%" class="uportal-text">
					<xsl:value-of select="$strSampleType"/>
				</td>
				<td width="5%"/>
				<td width="15%" class="uportal-label">

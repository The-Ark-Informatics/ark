...
<!-- 
    view_alert.xsl, part of the Workspace channel
...
<xsl:include href="../../common/common_btn_name.xsl"/>
    ...
    <xsl:param name="formParams">current=view_alert</xsl:param>
    ...
    <table width="100%">
        <tr>
            ...
            <td width="75%" class="uportal-channel-subtitle">
                      ...
                      <img name="view_alert" src="{$mediaPath}/casegenix/controls/view_alert_on.gif" border="0"></img> 
    ...
    <table width="100%">
        <tr>
            ...
            <td width="75%">
                ...
                <input type="button" name="delete" value="{$deleteBtnLabel}" tabindex="12" class="uportal-button" onclick="javascript:confirmDelete('{$baseActionURL}?current=view_alert&amp;WORKSPACE_ALERT_intAlertKey={$WORKSPACE_ALERT_intAlertKey}')" />
                <input type="button" name="clear" tabindex="13" value="{$clearBtnLabel}" class="uportal-button" onclick="javascript:confirmClear('{$baseActionURL}?current=create_alert')" />
            </td>
        </tr>
    </table>
    
    <!-- hidden fields to send data to server -->
    <input type="hidden" name="WORKSPACE_ALERT_intAlertKey" value="{$WORKSPACE_ALERT_intAlertKey}" />

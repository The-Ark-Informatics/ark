 ...
 * 
 */
public class ModuleFunctionContainerPanel extends AbstractContainerPanel<AdminVO> {
	...
	private DataView<ArkModuleFunction>						dataView;
	@SuppressWarnings("unchecked")
	private ArkDataProvider<ArkModuleFunction, IAdminService>	dataProvider;
	...
	private void initialiseDataView() {
		...
		dataProvider = new ArkDataProvider<ArkModuleFunction, IAdminService>(iAdminService) {
			...
			public Iterator<ArkModuleFunction> iterator(long first, long count) {

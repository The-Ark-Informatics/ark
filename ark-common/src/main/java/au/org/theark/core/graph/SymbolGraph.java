...
public class SymbolGraph {
    ...
    /**
     * Initializes a graph from a character array.
     * @param chars Character Array
     * @param delimiter String delimiter
     */
    public SymbolGraph(char[] chars,String delimiter) {
        st = new ST<String, Integer>();

        // First pass builds the index by reading strings to associate
        // distinct strings with an index
//        In in = new In(filename);
        InputStream is = new ByteArrayInputStream(String.valueOf(chars).getBytes());
        ...
        G = new Graph(st.size());
//        in = new In(filename);
        is = new ByteArrayInputStream(String.valueOf(chars).getBytes());

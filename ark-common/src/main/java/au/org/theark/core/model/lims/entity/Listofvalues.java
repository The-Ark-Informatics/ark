...
public class Listofvalues implements java.io.Serializable {
	...
	public Listofvalues(int id, Integer studyId, Integer deleted, String type,
			String value, Integer sortorder, Integer groupId,
			String description, String parenttype, String parentvalue,

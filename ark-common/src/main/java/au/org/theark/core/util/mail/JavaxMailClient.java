package au.org.theark.core.util.mail;
...
/**
 * Implementation of javax.mail API, to allow sending of an email from within the application (requires smtp setup)
 * 
 * @author cellis
 * 
 */
...
public class JavaxMailClient {
	private transient static Logger	log			= LoggerFactory.getLogger(JavaxMailClient.class);
	private String							host	= "smtp.ivec.org"; // change this to your host

...
public class ArkSettingsDataViewPanel<T extends Setting> extends Panel {
    ...
    public ArkSettingsDataViewPanel(String id, IDataProvider<Setting> dataProvider, Class<T> teir) {
        super(id);
        ArkSettingDataView<T> arkSettingDataView = new ArkSettingDataView<T>("settingsView", dataProvider, teir);

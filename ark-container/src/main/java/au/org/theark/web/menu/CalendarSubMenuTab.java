...
public class CalendarSubMenuTab extends AbstractArkTabPanel{
	...
	public CalendarSubMenuTab(String id) {
		super(id);
	...
	public void buildTabs() {		
		ArkModule arkModule = iArkCommonService.getArkModuleByName(au.org.theark.core.Constants.ARK_MODULE_CALENDAR);
		...
		for (final ArkFunction menuArkFunction : arkFunctionList) {
			moduleSubTabsList.add(new AbstractTab(new StringResourceModel(menuArkFunction.getResourceKey(), this, null)) {
				...
				public Panel getPanel(String panelId) {
					...
					processAuthorizationCache(au.org.theark.core.Constants.ARK_MODULE_CALENDAR, menuArkFunction);
					
					if (menuArkFunction.getName().equalsIgnoreCase(au.org.theark.core.Constants.FUNCTION_KEY_VALUE_CALENDAR)) {
		...
		ArkAjaxTabbedPanel moduleTabbedPanel = new ArkAjaxTabbedPanel(au.org.theark.core.Constants.CALENDAR_SUBMENU, moduleSubTabsList);

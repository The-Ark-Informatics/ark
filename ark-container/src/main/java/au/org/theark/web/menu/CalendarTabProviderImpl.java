...
public class CalendarTabProviderImpl extends Panel implements
		IMainTabProvider {

	private static final long serialVersionUID = 1L;
	private List<ITab> moduleTabsList;

	public CalendarTabProviderImpl(String panelId) {
		super(panelId);
	...
	public List<ITab> buildTabs() {
		// Main tab
		ITab iTab = createTab(au.org.theark.core.Constants.ARK_MODULE_CALENDAR);
	...
	public ITab createTab(String tabName) {
		return new ArkMainTab(new Model<String>(tabName)) {
			...
			public Panel getPanel(String pid) {
				...
				return new CalendarSubMenuTab(pid);
			}
			...
			public boolean isVisible() {
				return ArkPermissionHelper.isModuleAccessPermitted(au.org.theark.core.Constants.ARK_MODULE_CALENDAR);
			}
		};
	}
}

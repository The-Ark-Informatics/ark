...
//^BY is barcode Field Default

//		applet.append('^XA\n^FO50,50^ADN,36,20^FDHello World!\n');
//from page 20 of http://www.ptshome.com/kb/Manuals/ZPL_Vol1.pdf
		//applet.append('^XA^FO50,50^BY3');B2N bar code...worked but big...and Chris recommends Data Matric Barcode BX
		//applet.append('^B2N,150,Y,N,N');B2N bar code...worked but big...and Chris recommends Data Matric Barcode BX
		applet.append('^XA^FO,20');
		//applet.append('^BXN,1,200');
//		applet.append('^BXN,1,200,50,50,6,~');
		applet.append('^BXN,1,200,40,50,6,~');
		applet.append('^FD123456');
		applet.append('^FS\n');//^FS=FieldSeparator
		applet.append('^XZ\n');//^XZ=End Format.  
		
		// Send characters/raw commands to printer
		alert('before print 2')
		applet.print();
		alert('after print');
	}

/**
 * Merged all the individual scripts together.  Execute with the following command:
 *  mysql -u arkadmin -p < ark-0.1.5.sql
 */
-- MySQL dump 10.11
--
...
) ENGINE=InnoDB AUTO_INCREMENT=58 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`ADDRESS_TYPE_ID`) REFER `study/addre';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=12915 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`ACTION_TYPE_ID`) REFER `study/action';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=66668 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`PERSON_ID`) REFER `study/person`(`ID';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=66673 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`GENDER_TYPE_ID`) REFER `study/gender';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=4482 DEFAULT CHARSET=latin1 ROW_FORMAT=COMPACT;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`PERSON_ID`) REFER `study/person`(`ID';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`STUDY_STATUS_ID`) REFER `study/study';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`STUDY_ID`) REFER `study/study`(`ID`)';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=30 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`DELIMITER_TYPE_ID`) REFER `study/del';
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2011-10-10  1:48:39
...
-- Dump completed on 2011-10-10  1:54:28
...
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`STATUS_ID`) REFER `pheno/status`(`ID';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`COLLECTION_ID`) REFER `pheno/collect';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=847 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`FIELD_TYPE_ID`) REFER `pheno/field_t';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=869 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`COLLECTION_ID`) REFER `pheno/collect';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=9320 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`COLLECTION_ID`) REFER `pheno/collect';
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=1018 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`FIELD_ID`) REFER `pheno/field`(`ID`)';
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `pheno_data` (
  ...
  CONSTRAINT `FK_PHENO_DATA_PHENO_COLLECTION_ID` FOREIGN KEY (`PHENO_COLLECTION_ID`) REFERENCES `pheno_collection` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
SET character_set_client = @saved_cs_client;
...
) ENGINE=InnoDB AUTO_INCREMENT=55 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 9216 kB; (`DELIMITER_TYPE_ID`) REFER `pheno/del';
SET character_set_client = @saved_cs_client;
...
-- Dump completed on 2011-10-10  1:50:31
...
-- Dump completed on 2011-10-10  1:56:10
...
-- Dump completed on 2011-10-10  1:51:01
...
INSERT INTO `bio_transaction_status` (`ID`, `NAME`) VALUES (3,'Completed'),(1,'Initial Qty'),(2,'Pending');
...
-- Dump completed on 2011-10-10  1:58:51
...
-- Dump completed on 2011-10-10  1:52:16
...
-- Dump completed on 2011-10-10  1:57:57
...
-- Dump completed on 2011-10-10  1:51:29
...
-- Dump completed on 2011-10-10  1:56:50

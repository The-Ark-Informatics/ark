...
CREATE TABLE `upload` (
  ...
  `ARK_FUNCTION_ID` int(11) NOT NULL,
  `STATUS` enum('UPLOADED','PROCESSING','COMPLETE','ERRORS') DEFAULT NULL,
  ...
  CONSTRAINT `fk_upload_1` FOREIGN KEY (`UPLOAD_TYPE_ID`) REFERENCES `upload_type` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `ark_module` (`ID`, `NAME`, `DESCRIPTION`) VALUES (1,'Study','study'),(2,'Subject',NULL),(3,'Phenotypic',NULL),(4,'Genotypic',NULL),(5,'LIMS',NULL),(6,'Reporting',NULL),(7,'Admin',NULL);
...
INSERT INTO `ark_module_function` (`ID`, `ARK_MODULE_ID`, `ARK_FUNCTION_ID`, `FUNCTION_SEQUENCE`) VALUES (1,1,1,1),(2,1,2,2),(4,1,4,3),(5,2,5,1),(6,2,6,3),(7,2,7,4),(8,2,8,5),(9,2,9,6),(10,2,10,8),(11,2,11,9),(12,2,21,7),(23,1,23,NULL),(24,2,24,NULL),(25,2,25,NULL),(27,4,27,1),(31,2,34,2),(88,7,29,1),(89,7,30,2),(90,7,44,3),(91,7,45,4),(92,7,46,5),(93,7,28,6),(117,3,26,1),(118,3,12,2),(119,3,13,3),(120,3,14,4),(121,3,15,5),(122,3,16,6),(123,2,50,50),(126,5,17,1),(127,5,19,2),(128,5,20,3),(129,5,47,4),(130,5,35,5),(131,5,37,6),(132,5,42,7),(133,5,51,8),(134,5,52,9);

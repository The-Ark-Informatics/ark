...
CREATE TABLE `upload_type` (
  ...
  CONSTRAINT `fk_upload_type_ark_module` FOREIGN KEY (`ARK_MODULE_ID`) REFERENCES `ark_module` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
--
-- Table structure for table `link_billable_item_subject`
--

DROP TABLE IF EXISTS `link_billable_item_subject`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
INSERT INTO `ark_module` (`ID`, `NAME`, `DESCRIPTION`) VALUES (1,'Study','study'),(2,'Subject',NULL),(3,'Phenotypic',NULL),(4,'Genotypic',NULL),(5,'LIMS',NULL),(6,'Reporting',NULL),(7,'Admin',NULL),(8,'Work','Work Tracking Module');
...
INSERT INTO `billing_type` (`ID`, `NAME`, `DESCRIPTION`) VALUES (1,'CASH',NULL),(2,'CHEQUE',NULL),(3,'DRAFT',NULL);

...
--
-- Host: 192.168.3.253    Database: geno
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1 COMMENT='InnoDB free: 6144 kB; (`STATUS_ID`) REFER `geno/STATUS`(`ID`';
...
-- Dump completed on 2011-03-22 12:38:13

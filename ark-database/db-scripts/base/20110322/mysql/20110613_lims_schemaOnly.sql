...
CREATE INDEX `fk_collection_link_subject_study` ON `lims`.`collection` (`LINK_SUBJECT_STUDY_ID` ASC) ;

CREATE INDEX `fk_collection_study` ON `lims`.`collection` (`STUDY_ID` ASC) ;

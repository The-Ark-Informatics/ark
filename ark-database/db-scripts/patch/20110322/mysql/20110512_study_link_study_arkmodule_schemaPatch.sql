...
CREATE  TABLE `study`.`link_study_arkmodule` (
  ...
  PRIMARY KEY (`ID`) ,
  INDEX `FK_LINK_STUDY_MODULE_STUDY_ID` (`STUDY_ID` ASC) ,
  INDEX `FK_LINK_STUDY_ARK_MODULE_ID` (`ARK_MODULE_ID` ASC) ,
  CONSTRAINT `FK_LINK_STUDY_MODULE_STUDY_ID`
    FOREIGN KEY (`STUDY_ID` )
    REFERENCES `study`.`study` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FK_LINK_STUDY_ARK_MODULE_ID`

...
CREATE TABLE `lims`.`biocollection_custom_field_data` (
 ...
 PRIMARY KEY  (`ID`),
  KEY `FK_BIOCOLCFDATA_BIOCOLLECTION_ID` (`BIOCOLLECTION_ID`),
  ...
  CONSTRAINT `FK_BIOCOLCFDATA_BIOCOLLECTION_ID` FOREIGN KEY (`BIOCOLLECTION_ID`) REFERENCES `lims`.`collection` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION

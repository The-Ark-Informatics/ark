...
update	report	SET study_id = 415 where study_id =414;
update	entity	SET study_id = 415 where study_id =414;
update	reporting.Search	SET study_id = 415 where study_id =414;
update	entity	SET study_id = 415 where study_id =414;
update	Ark_User_Role	SET study_id = 415 where study_id =414;
update	Consent	SET study_id = 415 where study_id =414;
update	Correspondences	SET study_id = 415 where study_id =414;
update	Custom_Field	SET study_id = 415 where study_id =414;
update	Custom_Field_Group	SET study_id = 415 where study_id =414;
update	Link_Study_ArkModule	SET study_id = 415 where study_id =414;
update	Link_Study_Studycomp	SET study_id = 415 where study_id =414;
update	Link_Study_Studysite	SET study_id = 415 where study_id =414;
update	Link_Study_Substudy	SET study_id = 415 where study_id =414;
update	Link_Subject_Contact	SET study_id = 415 where study_id =414;
update	Link_Subject_Study	SET study_id = 415 where study_id =414;
update	Link_Subject_Studycomp	SET study_id = 415 where study_id =414;
update	Study_Comp	SET study_id = 415 where study_id =414;
update	Upload	SET study_id = 415 where study_id =414;

...
public class SearchForm extends AbstractSearchForm<DiseaseVO> {
	...
	private CompoundPropertyModel<DiseaseVO> cpModel;
	
	private WebMarkupContainer arkContextMarkup;
	
	private TextField<String> nameTextFld;
	
	public SearchForm(String id, CompoundPropertyModel<DiseaseVO> cpModel, PageableListView<DiseaseVO> listView, FeedbackPanel feedBackPanel, ArkCrudContainerVO arkCrudContainerVO, WebMarkupContainer arkContextMarkup) {
	...
	protected void initialiseSearchForm() {
		nameTextFld = new TextField<String>("disease.name");
	}

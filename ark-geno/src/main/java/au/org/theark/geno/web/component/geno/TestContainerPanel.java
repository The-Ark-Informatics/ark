package au.org.theark.geno.web.component.geno;
...
public class TestContainerPanel extends Panel{
	...
	public TestContainerPanel(String id) {
		...
		testForm.add(new Button(au.org.theark.geno.web.Constants.FIRETEST, new StringResourceModel("page.fireTest", this, null))
		{
		...
		testForm.add(new Button(au.org.theark.geno.web.Constants.WATERTEST, new StringResourceModel("page.waterTest", this, null))
		{
			public void onSubmit()
			{
		...
		testForm.add(new Button(au.org.theark.geno.web.Constants.NOAHTEST, new StringResourceModel("page.noahsRescue", this, null))
		{
			public void onSubmit()
			{
				log.info("Noah saves!");

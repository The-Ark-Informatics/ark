...
//					target.addComponent(detailPanelFormContainer);
		...
		private void initStatusDdc()
		{
			...
			ChoiceRenderer statusRenderer = new ChoiceRenderer(au.org.theark.geno.service.Constants.GENO_STATUS_NAME, 
																au.org.theark.geno.service.Constants.GENO_STATUS_ID);

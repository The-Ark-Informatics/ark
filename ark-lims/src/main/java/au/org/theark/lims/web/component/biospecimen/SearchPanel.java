...
public class SearchPanel extends Panel {
	...
	/* Constructor */
	public SearchPanel(String id, FeedbackPanel feedBackPanel, WebMarkupContainer searchMarkupContainer, PageableListView<Biospecimen> listView, WebMarkupContainer resultListContainer,

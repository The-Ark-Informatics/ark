...
public class AutoGenBatchCreateBiospecimenPanel extends Panel {
	...
	private AutoGenBatchCreateBiospecimenForm					form;

	public AutoGenBatchCreateBiospecimenPanel(String id, FeedbackPanel feedbackPanel, CompoundPropertyModel<LimsVO> cpModel, ModalWindow modalWindow) {
		super(id);
	...
	public void initialisePanel(ModalWindow modalWindow) {
		form = new AutoGenBatchCreateBiospecimenForm("batchCreateBiospecimenForm", cpModel, new Model<BatchBiospecimenVO>(new BatchBiospecimenVO()), modalWindow);
		form.initialiseForm();
		add(form);
	}
	 ...
	 */
	public AutoGenBatchCreateBiospecimenForm getListDetailForm() {
		return form;
	}
	 ...
	 */
	public void setListDetailForm(AutoGenBatchCreateBiospecimenForm listDetailForm) {

...
import au.org.theark.lims.web.component.biospecimenupload.BiospecimenUploadStep1;
import au.org.theark.lims.web.component.biospecimenupload.BiospecimenUploadStep2;
import au.org.theark.lims.web.component.biospecimenupload.BiospecimenUploadStep3;
import au.org.theark.lims.web.component.biospecimenupload.BiospecimenUploadStep4;
import au.org.theark.lims.web.component.biospecimenupload.BiospecimenUploadStep5;
...
public class WizardForm extends AbstractWizardForm<UploadVO> {
	...
	public void initialiseSteps() {
		BiospecimenUploadStep1 step1 = new BiospecimenUploadStep1("step", containerForm, this);
		BiospecimenUploadStep2 step2 = new BiospecimenUploadStep2("step", containerForm, this);
		BiospecimenUploadStep3 step3 = new BiospecimenUploadStep3("step", containerForm, this);
		BiospecimenUploadStep4 step4 = new BiospecimenUploadStep4("step", containerForm, this);
		BiospecimenUploadStep5 step5 = new BiospecimenUploadStep5("step", containerForm);

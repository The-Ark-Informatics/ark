		...
		PageableListView<Upload> sitePageableListView = new PageableListView<Upload>(Constants.RESULT_LIST, iModel, au.org.theark.core.Constants.ROWS_PER_PAGE) {
			...
			protected void populateItem(final ListItem<Upload> item) {
				...
				if (upload.getId() != null) {
					...
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_ID, upload.getId().toString()));
				}
				else {
				...
				if (upload.getFilename() != null) {
					// Add the id component here
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_FILENAME, upload.getFilename()));
				}
				else {
				...
				if (upload.getFileFormat() != null) {
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_FILE_FORMAT, upload.getFileFormat().getName()));
				}
				else {
				...
				if (upload.getUserId() != null) {
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_USER_ID, upload.getUserId()));
				}
				else {
				...
				if (upload.getStartTime() != null) {
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_START_TIME, upload.getStartTime().toString()));
				}
				else {
				...
				if (upload.getFinishTime() != null) {
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_FINISH_TIME, upload.getFinishTime().toString()));
				}
				else {
				...
				if (upload.getUploadStatus() != null && upload.getUploadStatus().getShortMessage()!=null) {
					item.add(new Label(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_UPLOAD_STATUS_NAME, upload.getUploadStatus().getShortMessage()));
				}
				else {

...
public class SearchForm extends AbstractSearchForm<UploadVO> {
	...
	private void initDropDownChoice() {
		...
		PropertyModel<Upload> uploadPm = new PropertyModel<Upload>(uploadCpm, au.org.theark.lims.web.Constants.UPLOAD);
		PropertyModel<FileFormat> fileFormatPm = new PropertyModel<FileFormat>(uploadPm, au.org.theark.lims.web.Constants.FILE_FORMAT);
		ChoiceRenderer fileFormatRenderer = new ChoiceRenderer(au.org.theark.lims.web.Constants.FILE_FORMAT_NAME, au.org.theark.lims.web.Constants.FILE_FORMAT_ID);
		fileFormatDdc = new DropDownChoice<FileFormat>(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_FILE_FORMAT, fileFormatPm, (List) fileFormatCollection, fileFormatRenderer);
	}

	public void initialiseFieldForm() {
		uploadIdTxtFld = new TextField<String>(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_ID);
		uploadFilenameTxtFld = new TextField<String>(au.org.theark.lims.web.Constants.UPLOADVO_UPLOAD_FILENAME);

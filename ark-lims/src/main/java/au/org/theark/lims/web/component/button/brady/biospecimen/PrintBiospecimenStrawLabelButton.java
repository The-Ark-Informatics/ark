...
public abstract class PrintBiospecimenStrawLabelButton extends AjaxButton {
	...
	public boolean isEnabled() {
		...
		if(barcodePrinter.getId() == null) {
			PrintBiospecimenStrawLabelButton.this.getParent().error("A Brady barcode printer is currently not available. Please add the printer to the client machine and try again");

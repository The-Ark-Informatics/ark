...
public class BioCollectionListForm extends Form<LimsVO>
{
	...
	private ArkDataProvider<BioCollection, ILimsService>	bioCollectionProvider;
	...
	private void initialiseDataView()
	{
		...
		bioCollectionProvider = new ArkDataProvider<BioCollection, ILimsService>(iLimsService)
		{
		...
		bioCollectionProvider.setModel(new LoadableDetachableModel<BioCollection>()
		{
			@Override
		...
		dataView = buildDataView(bioCollectionProvider);

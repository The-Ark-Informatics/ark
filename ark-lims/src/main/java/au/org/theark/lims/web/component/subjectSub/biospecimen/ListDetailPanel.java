...
public class ListDetailPanel extends Panel
{
	...
	public ListDetailPanel(String id, FeedbackPanel feedBackPanel, CompoundPropertyModel<LimsVO> cpModel)
	{
		super(id);
		this.feedBackPanel = feedBackPanel;
	...
	public void initialisePanel(CompoundPropertyModel<LimsVO> cpModel)
	{
		listDetailForm = new ListDetailForm("biospecimenListDetailForm", cpModel, feedBackPanel);
		listDetailForm.initialiseForm();
		add(listDetailForm);
	}

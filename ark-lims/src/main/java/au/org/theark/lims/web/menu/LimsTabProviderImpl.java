...
public class LimsTabProviderImpl extends Panel implements
		IMainTabProvider {
	...
	public List<ITab> buildTabs() {
		// Main tab
		ITab iTab = createTab(Constants.LIMS_MAIN_TAB);
	...
	public ITab createTab(String tabName) {
		return new ArkMainTab(new Model<String>(tabName)) {
			...
			public boolean isAccessible()
			{
				...
				{
					this.getPanel(Constants.LIMS_MAIN_TAB).error(au.org.theark.core.Constants.STUDY_IN_CONTEXT_MESSAGE);
					return false;
				}
				else
					return true;

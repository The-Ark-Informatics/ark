...
public class OldPhenoDataUploadJob implements Job {
	private static final Logger	log					= LoggerFactory.getLogger(OldPhenoDataUploadJob.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		long phenoTest = 3L;//TODO ASAP fix if used iPhenoService.getCountOfCollectionsInStudy(study);
	...
	//	OldPhenoDataUploader pi = new OldPhenoDataUploader(iPhenoService, study, phenoCollection, iArkCommonService, fileFormat, delimiterChar);

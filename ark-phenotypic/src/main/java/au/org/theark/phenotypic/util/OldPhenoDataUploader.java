...
public class OldPhenoDataUploader {/*
	...
	private Study							study;
	static Logger							log							= LoggerFactory.getLogger(OldPhenoDataUploader.class);
	 ...
	 *
	public OldPhenoDataUploader(IPhenotypicService iPhenoService, Study study, PhenoCollection collection, IArkCommonService<Void> iArkCommonService, String fileFormat, char delimiterChar) {

...
public class PhenoDataImporter {
	...
	private Study							study;
	static Logger							log							= LoggerFactory.getLogger(PhenoDataImporter.class);
	 ...
	 */
	public PhenoDataImporter(Study study, ArkFunction arkFunction, IArkCommonService<Void> iArkCommonService, 

...
public abstract class DeleteButton extends AjaxDeleteButton {
	...
	DeleteButton(final Upload upload, Component component) {
		...
		// delete=Delete
		super(au.org.theark.phenotypic.web.Constants.DELETE_FILE, new StringResourceModel("confirmDelete", component, null),
				new StringResourceModel(au.org.theark.phenotypic.web.Constants.DELETE, component, null));
	}

...
import au.org.theark.phenotypic.web.component.phenodatacategory.form.DetailForm;
...
public class DetailPanel extends Panel {
	...
	public DetailPanel(String id, FeedbackPanel feedbackPanel, CompoundPropertyModel<PhenoDataSetCategoryVO> cpModel, ArkCrudContainerVO arkCrudContainerVO){
		super(id, cpModel);

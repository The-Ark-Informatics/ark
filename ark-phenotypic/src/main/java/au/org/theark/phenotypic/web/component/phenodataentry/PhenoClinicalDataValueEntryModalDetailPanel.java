...
import au.org.theark.phenotypic.web.component.phenodataentry.form.PhenoClinicalDataValueEntryModalDetailForm;
import au.org.theark.phenotypic.web.component.phenodataentry.form.PhenoDataEntryModalDetailForm;

public class PhenoClinicalDataValueEntryModalDetailPanel extends Panel {
	...
	public PhenoClinicalDataValueEntryModalDetailPanel(String id, ModalWindow modalWindow, CompoundPropertyModel<PhenoDataCollectionVO> cpModel) {
		super(id);

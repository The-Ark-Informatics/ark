...
public class PhenoDataUploadStep2 extends AbstractWizardStepPanel {
	...
	public PhenoDataUploadStep2(String id, Form<UploadVO> containerForm, WizardForm wizardForm) {
	...
	public void onStepInNext(AbstractWizardForm<?> form, AjaxRequestTarget target) {
		if(containerForm.getModelObject().getPreviousStepOutCompleted()){
			try {
				...
				try{	
					validationMessages = phenoDataUploadValidator.validateCustomFieldFileFormat(containerForm.getModelObject(), phenoCollectionCriteria, cfgSelected);			

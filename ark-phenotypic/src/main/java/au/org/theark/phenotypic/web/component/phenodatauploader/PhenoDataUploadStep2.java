 ...
 */
public class PhenoDataUploadStep2 extends AbstractWizardStepPanel {

	/**
	 * 
	 */
	private static final long				serialVersionUID		= -6923277221441497110L;
	static Logger								log						= LoggerFactory.getLogger(PhenoDataUploadStep2.class);
	...
	public PhenoDataUploadStep2(String id) {
		super(id);
		initialiseDetailForm();
	}

	public PhenoDataUploadStep2(String id, Form<PhenoFieldDataUploadVO> containerForm, WizardForm wizardForm) {
	...
	public void onStepInNext(AbstractWizardForm<?> form, AjaxRequestTarget target) {
		try {
			...
			validationMessages = phenotypicValidator.validateMatrixPhenoDataFileFormat(inputStream, fileFormat, delimChar);
...
//			PhenoCollection phenoCollection = containerForm.getModelObject().getPhenoCollection(); // TODO: FIX
...
//			iPhenotypicService.createUpload(containerForm.getModelObject());// TODO: FIX

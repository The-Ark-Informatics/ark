 ...
 */
public class PhenoDataSetCategoryFieldUploadStep1 extends AbstractWizardStepPanel {
	...
	private DropDownChoice<UploadLevel>		phenoFieldUploadLevelDdc;
	// private UploadProgressBar uploadProgressBar;
	private DropDownChoice<DelimiterType>	delimiterTypeDdc;
	private WizardForm							wizardForm;
	

	public PhenoDataSetCategoryFieldUploadStep1(String id) {
		super(id);
	...
	private void initialiseDropDownChoices() {
		...
		phenoFieldUploadLevelDdc=new DropDownChoice<UploadLevel>(Constants.UPLOADVO_UPLOAD_UPLOAD_LEVEL, (List)uploadLevelCollection,uploadLevelRenderer);
		// Set the default
	...
	protected void attachValidators() {
		...
		phenoFieldUploadLevelDdc.setRequired(true).setLabel(new StringResourceModel("error.uploadLevel.required",this,new Model<String>("UploadLevel")));
	}

	private void addComponents() {
		// Add components here
		add(fileUploadField);
		add(phenoFieldUploadLevelDdc);

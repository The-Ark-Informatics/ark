...
public class SearchForm extends AbstractSearchForm<PhenoCollectionVO> {
	...
	public void initialiseFieldForm() {
		...
		if (sessionStudyId != null) {
			...
			chart = ChartFactory.createPieChart("Phenotypic Field Summary", d, true, // Show legend
					true, // Show tooltips
					true); // Show urls
			...
			chart = ChartFactory.createPieChart("Phenotypic Collection Summary", d, true, // Show legend
					true, // Show tooltips
					true); // Show urls
			chart.setBackgroundPaint(Color.white);
			chart.setBorderVisible(false);
			...
			chart = ChartFactory.createBarChart("Fields With Data", // Title

...
public class WorkResearcherCostReportContainer extends AbstractSelectedReportContainer<ResearcherCostResportVO>{
	...
	public WorkResearcherCostReportContainer(String id) {
		super(id);

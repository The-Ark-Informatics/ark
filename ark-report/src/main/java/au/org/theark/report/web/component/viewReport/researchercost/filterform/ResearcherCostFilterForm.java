...
import au.org.theark.report.web.component.viewReport.researchercost.WorkResearcherCostReportDataSource;

public class ResearcherCostFilterForm extends AbstractReportFilterForm<ResearcherCostResportVO> {
...
//	private TextField<String> yearTxtField;
	...
	protected void onGenerateProcess(AjaxRequestTarget target) {
		...
		try {
			...
			if (design != null) {
				design.setName(au.org.theark.report.service.Constants.WORK_RESEARCHER_COST_REPORT_NAME); // set the output file name to match report title

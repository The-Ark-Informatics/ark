(function () {
	...
	var REST_SERVICE_URI = 'http://demo.sphinx.org.au/ark/rest/study/';
	 ...
	 var REST_SERVICE_URI_RESOURCE = '/membership/';
    function Service($filter,$http,$q) {

        var service = {};
        var studyId=130;
      
        service.fetchAllMemberships = fetchAllMemberships;
		service.fetchMembershipBySubjectID = fetchMembershipBySubjectID;
   ...
   function fetchAllMemberships() {
	...
	function fetchMembershipBySubjectID (id) {
        var deferred = $q.defer();

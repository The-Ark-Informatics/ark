(function () {
    ...
    angular
        .module('app')
        .factory('VisualisationService', Service);
	var REST_SERVICE_URI = 'http://demo.sphinx.org.au/ark/rest/study/';
	 ...
	 var REST_SERVICE_URI_RESOURCE = '/visualise/';
   ...
   function fetchAllPedigrees() {
	...
	function fetchPedigreeByID (peds) {
	   var id='137';
        var deferred = $q.defer();
		 $http.post(REST_SERVICE_URI+studyId+REST_SERVICE_URI_RESOURCE,peds,
			 {
        withCredentials: true,
        headers:{ 'Authorization':  'Basic ' + btoa('demo-studyadmin@ark.org.au' + ":" + 'StudyAdmin@1')}})
         .then(

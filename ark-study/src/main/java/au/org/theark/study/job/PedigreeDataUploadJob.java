...
public class PedigreeDataUploadJob implements Job {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {		
		...
		try {
			...
			StringBuffer uploadReport = iStudyService.uploadAndReportPedigreeDataFile(inputStream, size, fileFormat, delimiter, studyId);

...
public class SubjectConsentDataUploadJob implements Job {
	 ...
	 */
	public SubjectConsentDataUploadJob() {
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {		
		...
		try {
			...
			StringBuffer uploadReport = iStudyService.uploadAndReportSubjectConsentDataFile(inputStream, size, fileFormat, delimiter, studyId);

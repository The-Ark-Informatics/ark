...
public class Constants {
	...
	public static final String[][]	SUBJECT_TEMPLATE_CELLS = {
		...
		{"DESCRIPTION","The unique identifier assigned for this subject.  This may be automatically generated on upload into The Ark","The title by which the subject prefers to be addressed","The subjects first name","The subjects middle name","The subjects last or family name","The name by which the subject prefers to be addressed","The date the subject was born","The subject's vital status","The subject's gender","The status of the subject as it pertains to the study","The date the subject died, if known","The cause of death","The marital status of the subject","The preferred method for contacting the subject","The subject's primary email address"},
		{"FORMAT","CHARACTER","CHARACTER","CHARACTER","CHARACTER","CHARACTER","CHARACTER","DD/MM/YYYY","CHARACTER","CHARACTER","CHARACTER","DD/MM/YYYY","ALPHANUMERIC","CHARACTER","CHARACTER","ALPHANUMERIC"},

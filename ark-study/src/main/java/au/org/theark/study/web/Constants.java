...
*/
	...
	public static final String[]		SUBJECT_TEMPLATE_HEADER										= { "SUBJECTUID", "FAMILY_UID", "TITLE", "FIRST_NAME", "MIDDLE_NAME", "LAST_NAME", "PREFERRED_NAME", "DATE_OF_BIRTH",
			...
			"CONSENT_DATE", "CONSENT_EXPIRY_DATE","CONSENT_STATUS", "CONSENT_TYPE", "CONSENT_TO_PASSIVE_DATA_GATHERING", "CONSENT_TO_ACTIVE_CONTACT", "CONSENT_TO_USE_DATA","CONSENT_DATE_OF_LAST_CHANGE"		
	};
...
//				"", "", "", "", "","", ""} };
	...
	public static final String[][]	SUBJECT_TEMPLATE_CELLS										= {
		...
		"The subject's date of consent","The subject's date of consent expiry", "The subject's consent status", "The subject's consent type", "The subject's consent to passive data gathering", "The subject's consent to active contact", "The subject's consent to use data","The subject's consent last changed date."},
		{ "FORMAT", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "DD/MM/YYYY", "CHARACTER", "CHARACTER", "CHARACTER", "DD/MM/YYYY", "DD/MM/YYYY", "ALPHANUMERIC", "CHARACTER",
		"CHARACTER", 
		"CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER",
		"CHARACTER", "DD/MM/YYYY", "CHARACTER", "CHARACTER", "ALPHANUMERIC",
		...
		"CHARACTER", "CHARACTER",
		"DD/MM/YYYY", "DD/MM/YYYY","CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER", "CHARACTER","DD/MM/YYYY"},

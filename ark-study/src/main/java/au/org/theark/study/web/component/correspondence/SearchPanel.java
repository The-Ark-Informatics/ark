...
public class SearchPanel extends Panel {
	...
	public SearchPanel(String id, FeedbackPanel feedBackPanel, PageableListView<Correspondences> listView, ArkCrudContainerVO arkCrudContainerVO) {
		super(id);
	...
	public void initialisePanel(CompoundPropertyModel<CorrespondenceVO> correspondenceVoCpm) {
		...
		SearchForm searchForm = new SearchForm(au.org.theark.core.Constants.SEARCH_FORM, correspondenceVoCpm, pageableListView, feedBackPanel, arkCrudContainerVO);

...
import au.org.theark.study.web.component.global.subject.form.DetailForm;
...
public class ChildStudySubjectPanel extends Panel {
	...
	private void setSubjectIntoContext(AjaxRequestTarget target, final SubjectVO subject) {
		...
		DetailForm detailForm = (DetailForm) wmc.getParent();
		DetailPanel detailPanel = (DetailPanel) detailForm.getParent();

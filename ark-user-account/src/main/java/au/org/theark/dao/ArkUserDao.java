...
/**
 * A Class that create a user account under ou=arkusers. With a userid, first,last name and password.
 * The intent of this class is to use it as a utility to create ark users who are supposed to be configured in the Ark Database (Ark_User and Ark_User_Role)
 * table as Super Administrators.
 * 
 * @author nivedann
 *
 */

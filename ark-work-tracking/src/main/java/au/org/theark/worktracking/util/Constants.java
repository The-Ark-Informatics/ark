...
public class Constants {
	...
	public static final String ERROR_WORK_RESEARCHER_ACCOUNTNAME_REQUIRED 								= "error.work.researcher.accountname.required";
	...
	public static final String ERROR_WORK_RESEARCHER_BANK_REQUIRED 										= "error.work.researcher.bank.required";

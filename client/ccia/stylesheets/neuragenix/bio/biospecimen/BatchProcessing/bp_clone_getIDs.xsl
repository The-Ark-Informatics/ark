                     ...
                     <tr>
                        ...
                        <xsl:choose>
                            <xsl:when test="$AutoGenerateBiospecimenID='true'">
                                <td colspan="2">
                                    Sample IDs are System Generated
                                </td>
                            </xsl:when>
                            <xsl:otherwise>
                                <td>
                                ...
                                <td> <input type="text" class="uportal-input-text" size="30" id="idMasterPrefix"/>  
        ...
        <table width="100%">
            <tr>
                <td width="1%" class="neuragenix-form-required-text">*</td>
                 <td width="35%" class="uportal-label">Sample ID </td>
               
                <td width="1%" class="neuragenix-form-required-text"></td>
               <td class="uportal-label" width="35%">Sample Barcode
               </td>
                <td width="1%" class="neuragenix-form-required-text">*</td>
               <td width="17%" class="uportal-label">Sample Project </td>
               <td>

...
>Next Match</a>
												...
												<table cellpadding="0" cellspacing="4" width="100%" border="0">
													...
													<tr valign="top">
														...
														<td><input type="text" align="right" name="PATIENT_strHospitalUR" tabindex="21" value="{$PATIENT_strHospitalUR}"/></td>
                                                                                                        ...
                                                                                                        <tr valign="top">
														<td class="form_label"><xsl:value-of select="PATIENT_strHospitalDisplay"/>&#160;:</td>
														<td>&#160;</td>
														<td>
															<select name="PATIENT_strHospital" tabindex="22" class="uportal-input-text">
													...
													<tr valign="top">
														...
														<td>
															...
															<xsl:choose>
                                                                                                                               ...
                                                                                                                               <xsl:when test="not(dob_editable=1)">
                                                                                                                                   <!-- Date of birth is locked -->
                                                                                                                               
                                                                                                                                     <td width="25%"> 

                                                                                                                                            <span class="uportal-label"> <xsl:value-of select="PATIENT_dtDob" /> </span>

                                                                                                                                            <xsl:for-each select="PATIENT_dtDob_Day">
                                                                                                                                                <xsl:variable name="dateDay"><xsl:value-of select="." /></xsl:variable>
                                                                                                                                                <!-- <xsl:if test="@selected='1'"> -->
                                                                                                                                                      <input type="hidden" name="PATIENT_dtDob_Day" value="{$dateDay}" />
                                                                                                                                                <!-- </xsl:if> -->
                                                                                                                                            </xsl:for-each>

                                                                                                                                            <xsl:for-each select="PATIENT_dtDob_Month">
                                                                                                                                                <xsl:variable name="dateMonth"><xsl:value-of select="." /></xsl:variable> 
                                                                                                                                                <!-- <xsl:if test="@selected='1'"> -->
                                                                                                                                                      <input type="hidden" name="PATIENT_dtDob_Month" value="{$dateMonth}" />
                                                                                                                                                <!-- </xsl:if> -->
                                                                                                                                            </xsl:for-each>

                                                                                                                                            <xsl:variable name="dateYear"><xsl:value-of select="PATIENT_dtDob_Year"/></xsl:variable>
                                                                                                                                            <input type="hidden" name="PATIENT_dtDob_Year" value="{$dateYear}" />
													...
													<tr valign="top">
														...
														<td><input type="text" align="right" name="PATIENT_intPhoneMobile" size="20" tabindex="34" value="{$PATIENT_intPhoneMobile}"/></td>
                                                                                                        ...
                                                                                                        <tr class="form_separator"><td colspan="3"><img width="1" height="1" border="0" src="{$infopanelImagePath}/spacer.gif"/></td></tr>
													<tr valign="top">
														<td class="form_label"><xsl:value-of select="PATIENT_strGestatDisplay"/>&#160;:</td>
														<td>&#160;</td>
														<td><input type="text" align="right" name="PATIENT_strGestat" size="20" tabindex="32" value="{PATIENT_strGestat}"/></td>
													</tr>
											...
											<td align="left" width="25%">
												<table cellpadding="0" cellspacing="4" width="100%" height="100%" border="0">
													...
													<tr valign="top">
														...
														<td>&#160;</td>
														<td>
															<select name="PATIENT_strSex" tabindex="34">
																...
																<xsl:for-each select="PATIENT_strSpecies">
																	<option>
																		...
																		<xsl:value-of select="."/>
                                                                                                        ...
                                                                                                        <!-- Patient Category -->
                                                                                                        <tr valign="top">
														<td class="form_label" width="40%"><xsl:value-of select="PATIENT_strCategoryDisplay"/>&#160;:</td>
														<td>&#160;</td>
														<td width="60%">
															<select name="PATIENT_strCategory" tabindex="36">
													...
													<!-- Diagnosis -->
                                                                                                        <tr valign="top">
														<td class="form_label"><xsl:value-of select="PATIENT_strDiagnosisDisplay"/>&#160;:</td>
														<td>&#160;</td>
														<td>
															<select name="PATIENT_strDiagnosis" tabindex="44">
		...
		<script language="JavaScript">
			document.patient_view.PATIENT_strHospitalUR.focus();
                        ...
                        disableDODField(document.patient_view.PATIENT_strCauseOfDeath);
		</script>
	</xsl:template>
</xsl:stylesheet>

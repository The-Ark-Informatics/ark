                        ...
                        <tr>
                            <td colspan="12" align="right">
                                <form name="next_form" action="{$baseActionURL}">
                                    ...
                                    <input type="submit" class="uportal-button" value="next"/>
                                    <input type="hidden" name="action"
                                        value="generate_id"/>
    ...
    <xsl:template match="details">
        ...
        <table width="100%">
            ...
            <tr>
                ...
                cells then click "Update Allocation" button to save this allocation.
                </td>
            </tr>
            <tr>
                <td>
                 ...
                 <td valign="top">   
                    <table>
                        <tr>
                            <td class="uportal-label">Selected Inventory Details</td>
                            <td></td>
                        </tr>
                        <tr>
                            <td><xsl:value-of select="//SITE_strTitleDisplay"/>:</td>
                            <td><xsl:value-of select="strSiteName"/></td>
                            
                        </tr>
                        <tr>
                            <td><xsl:value-of select="//TANK_strTitleDisplay"/>:</td>
                            <td><xsl:value-of select="strTankName"/></td>
                        </tr>
                        <tr>
                            <td><xsl:value-of select="//BOX_strTitleDisplay"/>:</td>
                            <td><xsl:value-of select="strBoxName"/></td>
                            
                        </tr>
                        <tr>
                            <td><xsl:value-of select="//TRAY_strTitleDisplay"/>:</td>
                            <td><xsl:value-of select="strTrayName"/></td>
                        </tr>
                        
                    </table>
                  </td>
                </tr>
                <!-- last row for the form and button-->
                <tr>
                   <td colspan="2" align="right">      
                    <form id="cell_form" action="{$baseActionURL}" method="post">
                        ...
                        <input id="submit_cell_form" type="submit" value="Update Allocation" style="display: none;"></input>
                    </form>    
                </td>
            </tr>
        ...
        <script language="javascript">
            ...
            document.getElementById('submit_cell_form').style.display = 'inline';
            
            }
            else document.getElementById('submit_cell_form').style.display = 'none';
            }
        </script>

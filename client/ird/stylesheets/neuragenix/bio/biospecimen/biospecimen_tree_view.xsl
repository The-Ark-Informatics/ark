	...
	<xsl:variable name="addpatientbuttonid" select="addpatientbutton" />
        ...
        <table width="100%">
            <tr>
                ...
                <xsl:if test="$callingDomain='patient'">
                    ...
                    <xsl:if test="$callingDomain='study'">

                    <form name="back_form" action="{$studyChannelURL}?uP_root=root" method="POST">
                        <input type="hidden" name="uP_sparam" value="activeTab" />
                        <input type="hidden" name="activeTab" value="2" />
                        <input type="hidden" name="target" value="study_allocation" />
                  
                        <input type="hidden" name="current" value="study_view" />
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td width="10%" class="uportal-label"><xsl:value-of select="BIOSPECIMEN_strSampleSubTypeDisplay" /></td>
                <td width="15%" class="uportal-label"><xsl:value-of select="BIOSPECIMEN_dtSampleDateDisplay" /></td>
                <td width="10%" style="text-align: right" class="uportal-label">Collected</td>
                <td width="10%" style="text-align: right" class="uportal-label">Removed</td>
                <td width="25%" style="text-align: center" class="uportal-label">Location</td>
            </tr>
                ...
                <!--
                    ...
                    <tr class="uportal-input-text">
                        ...
                        <td>
                           <xsl:if test="not(BIOSPECIMEN_strSampleSubType='NULL') or not(BIOSPECIMEN_strSampleSubType='null')">

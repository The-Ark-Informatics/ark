...
public class DAOQueryInvalidOrderByDirection extends DAOException{
    ...
    public DAOQueryInvalidOrderByDirection() {
    ...
    public DAOQueryInvalidOrderByDirection(String msg) {

...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template match="layout">
    <html>
      <head>
        <title>Neuragenix Risk Centre</title>
        <link type="text/css" rel="stylesheet" href="{$mediaPath}/{$skin}/skin/{$skin}.css"/>
        <script language="JavaScript">function openBrWindow(theURL,winName,features) {window.open(theURL,winName,features);}</script>
      </head>
  ...
  <xsl:template match="header">
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr class="uportal-background-med">
        <td nowrap="nowrap">
          <a href="http://www.neuragenix.com">
            <img alt="interface image" src="{$mediaPath}/{$skin}/institutional/logo_small.gif" border="0"/>
          </a>
        </td>
...
<!--   ************ Login section *******-->
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr class="neuragenix-logo-background">
        <td colspan="1" rowspan="1">
            <img alt="interface image" src="{$mediaPath}/{$skin}/institutional/logo.gif" border="0"/>
        </td>
      </tr>
    </table>
  </xsl:template>
...
<!--          <td class="uportal-background-dark">
  ...
  <xsl:template name="controls">
          ...
          <!-- Detach button -->
          <a href="#" onClick="openBrWindow('{$baseActionURL}?uP_detach_target={@ID}','detachedChannel','toolbar=yes,location=yes,status=yes,menubar=yes,scrollbars=yes,resizable=yes,width=640,height=480')">f

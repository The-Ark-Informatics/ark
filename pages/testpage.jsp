...
<jp:print id="print01"/>
<c:set target="${print01}" property="reportTitle" value="${title01}" />
<c:set target="${table01.rowAxisBuilder.axisConfig.propertyConfig}" property="showProperties" value="true" />

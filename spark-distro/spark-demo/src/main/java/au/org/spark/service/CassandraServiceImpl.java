...
//		sb.append(" PRIMARY KEY (id, individualId)");
		...
		cassandraOperations.execute("CREATE INDEX "+ tableName + "_id ON "+ tableName +" (id);");
		cassandraOperations.execute("CREATE INDEX "+ tableName + "_famid ON "+ tableName +" (famid);");
		cassandraOperations.execute("CREATE INDEX "+ tableName + "_pheno ON "+ tableName +" (pheno);");
		cassandraOperations.execute("CREATE INDEX "+ tableName + "_sex ON "+ tableName +" (sex);");

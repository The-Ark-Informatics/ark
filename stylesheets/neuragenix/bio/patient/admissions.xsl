		...
		<form name="collection_view" action="{$baseActionURL}?uP_root=root&amp;action=admissions" method="post">
			...
			<table width="100%">
                                ...
                                <td width="25%">
                                    <xsl:choose>
                                        <xsl:when test="string-length($editAdmissionSelected) &gt; 0">
                                            <span class="uportal-text"><xsl:value-of select="ADMISSIONS_intAdmissionkey"/></span>                                            
                                        </xsl:when>
                                        <xsl:otherwise>
				 ...
				 <td width="1%" class="neuragenix-form-required-text"/>
                               ...
                               Study: </td>
                                <td width="25%">
                                <select name="ADMISSIONS_intStudyID" tabindex="25" class="uportal-input-text">
				 ...
				 <td width="1%" class="neuragenix-form-required-text"/>
                                ...
                                Sub Study: </td>
                                <td width="25%">
                                <select name="ADMISSIONS_intSubStudyID" tabindex="25" class="uportal-input-text">
                                        <xsl:for-each select="substudy_list">
                                            <option>
                                                <xsl:attribute name="value"><xsl:value-of select="SUBSTUDY_intSubStudyID"/></xsl:attribute>
                                                <xsl:if test="@selected=1">
                                                        <xsl:attribute name="selected">true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="SUBSTUDY_strSbStudyName"/>
                                            </option>
                                        </xsl:for-each>
                                    </select>
                                ...
                                <td width="25%">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="ADMISSIONS_dtAdmission/@display_type='dropdown'">
                                            <select name="ADMISSIONS_dtAdmission_Day" tabindex="21" class="uportal-input-text">
                                            ...
                                            <select name="ADMISSIONS_dtAdmission_Month" tabindex="22" class="uportal-input-text">
                                        ...
                                        <xsl:otherwise>
                                            <input type="text" name="ADMISSIONS_dtAdmission_Day" value="{$dtAdmission_Day}" size="2" tabindex="21" class="uportal-input-text"/>
                                            <input type="text" name="ADMISSIONS_dtAdmission_Month" value="{$dtAdmission_Month}" size="2" tabindex="22" class="uportal-input-text"/>
                                        </xsl:otherwise>
                                    </xsl:choose>
                                    <input type="text" name="ADMISSIONS_dtAdmission_Year" value="{$dtAdmission_Year}" size="5" tabindex="23" class="uportal-input-text"/>
                                </td>
                                <td width="10%"/>
                             <!--   <td width="1%" class="neuragenix-form-required-text"/>
                                <td width="19%" class="uportal-label">
                                Sub Study: </td>
                                <td width="25%">
				<select name="ADMISSIONS_intGroupKey" tabindex="25" class="uportal-input-text">
                                        <xsl:for-each select="study_list">
                                            <option>
                                                <xsl:attribute name="value"><xsl:value-of select="STUDY_intStudyID"/></xsl:attribute>
                                                <xsl:if test="@selected=1">
			        ...
			        <td width="25%"> 
			            <select name="ADMISSIONS_strRefDoctor" tabindex="36" class="uportal-input-text">
                            ...
                            <!--<tr>
                                ...
                                <td width="25%">
                                    <select name="ADMISSIONS_strCollectGrp" tabindex="24" class="uportal-input-text">
                                ...
                                <td width="25%">
                                        <xsl:choose>
                                                <xsl:when test="ADMISSIONS_dtSurgery/@display_type='dropdown'">
                                                        <select name="ADMISSIONS_dtSurgery_Day" tabindex="33" class="uportal-input-text">
                                                        ...
                                                        <select name="ADMISSIONS_dtSurgery_Month" tabindex="34" class="uportal-input-text">
                                                ...
                                                <xsl:otherwise>
                                                        <input type="text" name="ADMISSIONS_dtSurgery_Day" value="{$dtSurgery_Day}" size="2" tabindex="33" class="uportal-input-text"/>
                                                        <input type="text" name="ADMISSIONS_dtSurgery_Month" value="{$dtSurgery_Month}" size="2" tabindex="34" class="uportal-input-text"/>
                                                </xsl:otherwise>
                                        </xsl:choose>
                                        <input type="text" name="ADMISSIONS_dtSurgery_Year" value="{$dtSurgery_Year}" size="4" tabindex="35" class="uportal-input-text"/>
                                </td>
                            </tr>-->
                            ...
                            <!--<tr>
                                ...
                                <td width="25%">
                                    <select name="ADMISSIONS_strEpisodeNo" tabindex="25" class="uportal-input-text">
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <select name="ADMISSIONS_strHospital" tabindex="25" class="uportal-input-text">
                            ...
                            <!--<tr>
                                ...
                                <td width="25%">
                                        <input type="text" align="left" name="ADMISSIONS_strHospitalUR" size="20" tabindex="32" value="{$ADMISSIONS_strHospitalUR}" class="uportal-input-text" />
                                </td>
                            </tr>-->
                            ...
                            <tr>
                                ...
                                <td width="74%" valign="left">
                                        <textarea class="uportal-input-text" cols="45" rows="2" tabindex="26" name="ADMISSIONS_strComments">
                            ...
                            <tr>
                                ...
                                <td width="19%" class="uportal-label" valign="top">
                                    <xsl:choose>
                                        <xsl:when test="string-length($editAdmissionSelected) &gt; 0">
                                            <input valign="left" type="button"  tabindex="39" name="cancel" value="Cancel" class="uportal-button" onclick="javascript:window.location='{$baseActionURL}?uP_root=root&amp;action=admissions&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}'"/>                        
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <input valign="left" type="button"  tabindex="36" name="clear" value="Clear" class="uportal-button" onclick="javascript:window.location='{$baseActionURL}?uP_root=root&amp;action=admissions&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}'"/>                        
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </td>
                                <td width="74%" valign="top" align="right">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="string-length($editAdmissionSelected) &gt; 0">
                                            <input type="submit" name="updateAdmission" tabindex="38" value="Update" class="uportal-button" onclick="javascript:selectAllDiagnosis()" />                                                
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <input type="submit" name="addAdmission" tabindex="38" value="Add" class="uportal-button" onclick="javascript:selectAllDiagnosis()" />
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </td>
                                <td width="5%" id="neuragenix-end-spacer"/>                                

													...
													<tbody>
														<tr>
															<td align="right" width="50%">
																...
																<a href="{$biospecimenChannelURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab=3&amp;BIOSPECIMEN_intStudyID={$intStudyID}&amp;BIOSPECIMEN_strSampleType={$biospecimenType}&amp;BIOSPECIMEN_strSampleSubType={$biospecimenSubType}&amp;BIOSPECIMEN_TRANSACTIONS_searchType=1&amp;module=biospecimen_search&amp;action=studyalloc">
													...
													<tbody>
														<tr>
															<td align="right" width="50%">
																<xsl:variable name="biospecimenType" select="STUDY_ALLOCATION_strBiospecimenType"/>
																<xsl:variable name="biospecimenSubType" select="STUDY_ALLOCATION_strBiospecimenSubType"/>
																<a href="{$biospecimenChannelURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab=3&amp;BIOSPECIMEN_intStudyID={$intStudyID}&amp;BIOSPECIMEN_strSampleType={$biospecimenType}&amp;BIOSPECIMEN_strSampleSubType={$biospecimenSubType}&amp;BIOSPECIMEN_TRANSACTIONS_searchType=2&amp;module=biospecimen_search&amp;action=studyalloc">

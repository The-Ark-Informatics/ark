	...
	<xsl:template match="login-status">
		...
		<xsl:if test="$unauthenticated!='false'">
			<table cellpadding="5" cellspacing="0" width="100%" border="0"
				style="height : 120px; background-position: center right; background-image : url('{$loginImagePath}/login_login_strip_bg.jpg'); background-repeat : no-repeat;">
						...
						<td align="left">
							<table cellpadding="1" cellspacing="0" border="0" width="600">
								<tr>
									...
									<td>
										<span style="color : #6c2535; font-size : 14px; font-weight : bold;">LOGIN</span>
									</td>
									<td colspan="2">
										<xsl:choose>

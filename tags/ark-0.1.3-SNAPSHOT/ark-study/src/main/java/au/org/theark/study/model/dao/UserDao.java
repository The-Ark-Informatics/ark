...
public class UserDao extends HibernateSessionDao implements IUserDao{
	...
	/**
	 * Checks if the Ark User is present in the system. IT does no compare with a particular Study.
	 * If a person existed in the system this will return true. This must be used only during create operation. If you want to 
	 * add a ArkUser to another study then another method with study must be passed in.
	 */

...
<xsl:include href="../../../common/common_btn_name.xsl"/>
    ...
    <xsl:param name="formParams">current=view_optionpool</xsl:param>
    ...
    <xsl:param name="OPTIONPOOL_strOptionPoolDesc"><xsl:value-of select="OPTIONPOOL_strOptionPoolDesc" /></xsl:param>
    ...
    <table width="100%">
        <tr>           
            ...
            <td width="66%" class="uportal-label">  
                         <span class="uportal-channel-current-subtitle"> View OptionPool</span>
            ...
            <td width="5" class="uportal-label" align="right">
                <input type="submit" name="backtoAddEditOptions" tabindex= "8" value="{$backBtnLabel}" class="uportal-button" />
            </td>
        </tr>        
    </table>
    <hr/>
    ...
    <table width="115%">
        <tr valign="top">
			...
			<td width ="80%" class="uportal-text">				
				<xsl:if test="$OPTIONPOOL_intOptionPoolID != ''">
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" name="OPTIONPOOL_strOptionPoolName" value="{$OPTIONPOOL_strOptionPoolName}" size="41" tabindex="1" class="uportal-input-text" />                            
                        </td>
                    </tr>
                    <tr>
                        <td width="20%" class="uportal-label">
               ...
               <table width="100%">
                    <tr>	
                        ...
                        <input type="submit" name="updateOptionPool" tabindex="4" value="{$updateBtnLabel}" class="uportal-button" />
                        <input type="button" name="deleteOptionPool" tabindex="5" value="{$deleteBtnLabel}" class="uportal-button" onclick="javascript:confirmDeleteOptionPool('{$baseActionURL}?current=view_optionpool&amp;OPTIONPOOL_intOptionPoolID={$OPTIONPOOL_intOptionPoolID}&amp;OPTIONPOOL_strOptionPoolName={$OPTIONPOOL_strOptionPoolName}&amp;OPTIONPOOL_strOptionPoolDesc={$OPTIONPOOL_strOptionPoolDesc}&amp;DATAELEMENTS_intDataElementIDselected={$DATAELEMENTS_intDataElementIDselected}&amp;SMARTFORM_intSmartformID={$SMARTFORM_intSmartformID}&amp;DEPoolSelected={$DEPoolSelected}&amp;OptionPoolSelected={$OptionPoolSelected}')"/>

            ...
            <tr valign="top">
                ...
                <td width="80%">
                        ...
                        <tr>
                            <td>
                                ...
                                <form action="{$baseActionURL}" method="POST">
                                    ...
                                    <input type="submit" value="Add sub biospecimen" tabindex="80"
                            ...
                            <td>
                                ...
                                <xsl:if test="biospecimen_modules/batchCreating='true'">
                                    ...
                                    <form
                                        action="{$baseActionURL}?module=BATCH_CREATION&amp;action=batch_create_start&amp;intParentBiospecimenKey={BIOSPECIMEN_intBiospecimenID}&amp;BIOSPECIMEN_strBiospecimenID={BIOSPECIMEN_strBiospecimenID}&amp;BIOSPECIMEN_strSampleType={BIOSPECIMEN_strSampleType}"
                                        method="post">
                                        
                                        <input type="hidden" name="intPatientKey" value="{$intInternalPatientID}"/>
                                        <input type="submit" class="uportal-button"
                                            value="Batch Create" tabindex="82"/>
                                    </form>
                                    </xsl:if>
                                </xsl:if>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="SITE_strTitleDisplay"/>: </td>
                                ...
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="TRAY_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                            ...
                            <tr>
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="TANK_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                            ...
                            <tr>
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label"> <xsl:value-of select="BOX_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                                ...
                                <td colspan="2" class="uportal-text">
                                    <xsl:choose>
                                        <xsl:when test="inventory_info/SITE_strSiteName = 'N/A'">
                                            <form
                                                action="{$inventoryChannelURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab=3&amp;source=allocate&amp;intInternalPatientID={$intInternalPatientID}&amp;BIOSPECIMEN_intBiospecimenID={$intBiospecimenID}&amp;strOrigin=view_biospecimen"
                                                method="post">
                                                <input type="submit" class="uportal-button"
                                                  value="Allocate"/>
                                            </form>
                    ...
                    <table width="100%">
                        <tr>
                            <td/>
                            <td class="uportal-channel-table-header" colspan="4">Notes:</td>
                            <td/>
                            
                        </tr>
                        <tr>
                            <td/>
                            <td width="60%" class="uportal-label">Description</td>
                            <td width="20%" class="uportal-label">Date Added</td>
                            <td width="18%"/>
                        </tr>
                        <xsl:for-each select="./biospecimen_notes/notes">
                            ...
                            <td class="uportal-input-text">
                                <a href="{$baseActionURL}?module=NOTES&amp;action=delete_notes&amp;NOTES_intNotesKey={$intNoteKey}
                                &amp;BIOSPECIMEN_intBiospecimenID={$intBiospecimenID}"> Delete</a>
                            </td>
                            </tr>
                    ...
                    <form name="notes_form" action="{$baseActionURL}" method="post">
                        ...
                        <input type="hidden" name="BIOSPECIMEN_intBiospecimenID" value="{$intBiospecimenID}"/>
                            ...
                            <tr>
                                <td/>
                                <td valign="top" class="uportal-label">Notes:</td>
                                <td valign="top">
                                    <textarea name="NOTES_strDescription" rows="4"
                                        cols="40" tabindex="60" class="uportal-input-text"/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="4" align="right">
                                    <input type="submit" class="uportal-button" tabindex="61" value="Add Note"/>

...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="biospecimen">
        ...
        <xsl:param name="intParentBiospecimenID"><xsl:value-of select="intParentBiospecimenID" /></xsl:param>
        ...
        <xsl:param name="VIAL_CALCULATION_strBiospecimenKeys"><xsl:value-of select="VIAL_CALCULATION_strBiospecimenKeys" /></xsl:param>
	...
	<table width="100%">
        ...
        <form name="history_form" action="{$baseActionURL}?current=vial_history" method="post">
                    ...
                    <tr>
                        <td width="50%">
                            <table width="100%">
                                ...
                                <xsl:for-each select="biospecimens">
									
																<xsl:sort select="translate(translate(translate(translate(translate(translate(translate(translate(translate(translate(substring-before(strBiospecimenID, '-'), 'A','01'), 'D', '02'), 'G','03'), 'M', '05'), 'N', '06'), 'P', '07'), 'R', '08'), 'S', '09'), 'W', '10'), 'H', '04')" data-type="number" order="ascending"/>
																<xsl:sort select="translate(translate(translate(translate(translate(translate(translate(translate(translate(translate(substring-after(strBiospecimenID, '-'), 'A','01'), 'D', '02'), 'G','03'), 'M', '05'), 'N', '06'), 'P', '07'), 'R', '08'), 'S', '09'), 'W', '10'), 'H', '04')" data-type="number" order="ascending"/>
            ...
            <table width="100%">
                ...
                <tr>
					<td><input type="submit" class="uportal-button" value="Back To Biospecimen"/> </td>
                                        
                                        <xsl:if test="intParentBiospecimenID='-1'">
                                            <td align="right"><input type="button" class="uportal-button" value="Delete Vial Calculation" onClick="javascript:confirmDelete('{$baseActionURL}')"/> </td>
                                        </xsl:if>
					<script>
						...
						{ 
							...
							{
								//document.history_form.action=action; 
								document.history_form.subAction.value='deleteVialCalculation'; 
            ...
            <input type="hidden" name="subAction" value=""></input>
			<input type="hidden" name="VIAL_CALCULATION_strBiospecimenKeys" value="{$VIAL_CALCULATION_strBiospecimenKeys}"></input>
        </form>
        </td>
        </tr>
        </table>

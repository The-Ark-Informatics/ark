...
<!--
    Document   : add_dataelementpool.xsl
...
<xsl:include href="../../../common/common_btn_name.xsl"/>
    ...
    <xsl:param name="formParams">current=add_dataelementpool</xsl:param>
    ...
    <table width="100%">
        <tr>           
            ...
            <td width="66%" class="uportal-label">   
                <span class="uportal-channel-current-subtitle">Add DataElementPool</span>
            ...
            <td width="5" class="uportal-label" align="right">
                <input type="submit" name="backtoAddEditDataElements" tabindex= "7" value="{$backBtnLabel}" class="uportal-button" />
            </td>
        </tr>        
    </table>
    <hr/>   
            ...
            <td width="77%">
			    ...
			    System generated                
                    ...
                    <tr>
                        ...
                        <td width="80%">
                            <input type="text" name="DATAELEMENTPOOL_strDataElementPoolName" size="41" tabindex="1" class="uportal-input-text" value="{$DATAELEMENTPOOL_strDataElementPoolName}" />
               ...
               <table width="100%">
                    <tr>	
                        ...
                        <input type="submit" name="saveNewDataElementPool" tabindex="4" value="{$saveBtnLabel}" class="uportal-button" />                        
                        </td>                 
                        <td width="80%"></td>  
                     </tr>                                                                  
                </table>

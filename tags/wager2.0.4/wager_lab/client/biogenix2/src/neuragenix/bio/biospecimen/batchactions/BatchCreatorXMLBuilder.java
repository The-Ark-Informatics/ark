...
public class BatchCreatorXMLBuilder {
	...
	public String buildEditDetailsForm(BatchCreator bcreator, int internalGenerationID, ChannelRuntimeData rd) throws Exception{
		...
		sbXML.append(StudyUtilities.getListOfStudiesXML(blShowExpiredStudies, blShowNonConsentedStudies,bcreator.getIntPatientKey(), StudyUtilities.DOMAIN_BIOSPECIMEN, null));

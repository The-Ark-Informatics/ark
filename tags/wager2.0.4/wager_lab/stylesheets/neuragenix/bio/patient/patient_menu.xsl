					...
					<table cellpadding="0" cellspacing="0" width="250" border="0">
						...
						<tr valign="top">
							<td align="left">
								...
								<!--Seena                            <xsl:variable name="PATIENT_strHospitalUR"><xsl:value-of select="/body/search/PATIENT_strHospitalUR"/></xsl:variable> -->
								...
								<table class="funcpanel" cellpadding="0" cellspacing="0" border="0" width="100%">
									<form name="patient_search" action="{$baseActionURL}?action=search_patient&amp;newSearch=true" method="post">
										...
										<xsl:if test="$disable-PATIENT_strPatientID != 'true'">
											...
											<td>&#160;</td>
											<td><input class="funcpanel_form" type="text"   name="PATIENT_strPatientID" size="20"/></td>
										...
										<xsl:if test="$disable-PATIENT_strSurname != 'true'">
											...
											<td>&#160;</td>
											<td><input class="funcpanel_form" type="text"   name="PATIENT_strSurname" size="20"/></td>
											<td class="funcpanel_right_border">&#160;</td>
										</tr>
										<tr class="funcpanel_content">
											<td class="funcpanel_content_spacer" colspan="5"><img width="1" height="4" src="{$spacerImagePath}"/></td>
										...
										<tr class="funcpanel_content">
											...
											<td>&#160;</td>
											<td><input class="funcpanel_form" type="text"  name="PATIENT_strFirstName" size="20"/></td>
											<td class="funcpanel_right_border">&#160;</td>
										</tr>
										<tr class="funcpanel_content">
											<td class="funcpanel_content_spacer" colspan="5"><img width="1" height="4" src="{$spacerImagePath}"/></td>
											...
											<td>
												<xsl:choose>
													<xsl:when test="PATIENT_dtDob/@display_type='dropdown'">
														...
														<select name="PATIENT_dtDob_Month" >
															<option value=""/>
													...
													<!-- when it is a text-->
													<xsl:otherwise>
														<input class="funcpanel_form" type="text" name="PATIENT_dtDob_Day" size="2" >
														</input>
														<input class="funcpanel_form" type="text" name="PATIENT_dtDob_Month" size="2" >
														</input>
													</xsl:otherwise>
												</xsl:choose>
												<input class="funcpanel_form" type="text" name="PATIENT_dtDob_Year" size="6" >
												</input>
											</td>
											<td class="funcpanel_right_border">&#160;</td>
										</tr>
...
<input type="hidden" name="/body/search/PATIENT_strSpecies" value="Human" />
										<tr class="funcpanel_content">
                                                                                        <td class="funcpanel_left_border">&#160;</td>
                                                                                        <td class="form_label">Study &#160;:</td>
                                                                                        <td>&#160;</td>
                                                                                        <td>
                                                                                                <select class="funcpanel_form" name="intStudyID" >
													<option value=""></option>
                                                                                                        <xsl:for-each select="/body/search/study_list">
                                                                                                                <option>
...
<!--                                                                                <xsl:if test="$disable-PATIENT_strSpecies != 'true'">
										<tr class="funcpanel_content">
											...
											<td>&#160;</td>
											<td>
												<select class="funcpanel_form" name="PATIENT_strSpecies" >
										...
										<tr valign="top">
											...
											<td class="funcpanel_footer" align="right" colspan="3" width="100%">
												<input class="submit_image_button" type="image" src="{$buttonImagePath}/search_enabled.gif"  name="submit" value="Search"
...
-->
		 ...
		 <script language="JavaScript">
                        document.patient_search.PATIENT_strPatientID.focus();
                </script>

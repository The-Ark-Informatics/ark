	...
	<table width="100%">
        ...
        <table width="100%">
            ...
            <xsl:if test="AllocationType=1">
                <tr>
                 <td colspan="2">
                    <span class="uportal-text">The following samples are now assigned to project: <xsl:value-of select="STUDY_strStudyName" /></span>
            ...
            <tr>
                ...
                <td>
                       ...
                       <input type="submit" name="finish" value="Return to sample search &gt;" class="uportal-input-text" />             

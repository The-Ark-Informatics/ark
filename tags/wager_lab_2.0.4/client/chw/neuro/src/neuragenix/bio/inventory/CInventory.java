	...
	//add sort type
        switch (node.getLevel())
        {
            ...
            case 1:
                ...
                strResult += "<SITE_strSiteName>" + hashTemp.get("SITE_strSiteName") + "</SITE_strSiteName>";
            ...
            case 2:
                ...
                //System.out.println("TIME STAMP:" + hashTemp.get("TANK_strTimeStamp"));
                ...
                strResult += "<TANK_strTankName>" + hashTemp.get("TANK_strTankName") + "</TANK_strTankName>";
            ...
            case 3:
                ...
                strResult += "<BOX_strBoxName>" + hashTemp.get("BOX_strBoxName") + "</BOX_strBoxName>";
                strResult += "<usage>" + usage + "</usage>";
            ...
            case 4:
                ...
                strResult += "<TRAY_strTrayName>" + hashTemp.get("TRAY_strTrayName") + "</TRAY_strTrayName>";
                strResult += "<usage>" + usage + "</usage>";
...
// LogService.instance().log("strXML = " + strXML);
    ...
    private String buildCellXMLFile(int intTrayID)
    {
        ...
        try
        {
            ...
            ResultSet rsResultSet = query.executeSelect();
            // Declare and instantiate PatientUtilities object
            PatientUtilities patUtil = new PatientUtilities();
                ...
                for (int i=0; i < intNoOfRow + 1; i++)
                {
                    ...
                    for (int j=0; j < intNoOfCol + 1; j++)
                    {
                        ...
                        else
                        {
                            ...
                            // Declare and instantiate the 3 elements required to be displayed in onMouseOver
                            // cell by calling the getPatientDetails function.
                            String strPatientID = patUtil.getPatientDetails(patientID, "PATIENT_strPatientID", authToken);
                            String strPatientName = patUtil.getPatientDetails(patientID, "PATIENT_strFirstName", authToken);
                            String strPatientSurname = patUtil.getPatientDetails(patientID, "PATIENT_strSurname", authToken);
                            ...
                            strXML += "<CELL_intPatientID>" + strPatientID + "</CELL_intPatientID>";
                            
                            if (biospecimenID == -1)
                            {
                                strXML += "<CELL_info>Location ID : " + NeuroUtils.getLocationID(j, i, intNoOfRow, intNoOfCol) + "&#10;&#13;";
                                strXML += "Cell ID: " + cellID + "&#10;&#13;";
                            ...
                            else
                            {
                                ...
                                strXML += "Patient ID: " + strPatientID + "&#10;&#13;";
                                strXML += "Patient Name: " + strPatientName + " " + strPatientSurname + "&#10;&#13;";

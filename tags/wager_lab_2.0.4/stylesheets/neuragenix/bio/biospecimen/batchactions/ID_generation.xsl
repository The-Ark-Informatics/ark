                        ...
                        <table width="100%">
                                ...
                                <xsl:for-each select="biospecimen">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <xsl:value-of
                                                select="../GenerationDetails/BIOSPECIMEN_TRANSACTIONS_strUnit"
                                            />
                                        </td>
                                        <td>
                                            <xsl:choose>
                            ...
                            <tr>
                                <td colspan="12" align="right">
                                    <input type="button" value="back" onclick="javascript:document.back_form.submit();"/>
                                    <input type="submit" value="Save and Generate Report"/>

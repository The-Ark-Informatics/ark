...
<xsl:include href="../../../common/common_btn_name.xsl"/>
    ...
    <!-- FORM LINK -->
    <xsl:param name="DATAELEMENTS_strChannelFunctionalName"><xsl:value-of select="DATAELEMENTS_strChannelFunctionalName" /></xsl:param>
    <xsl:param name="DATAELEMENTS_strPageName"><xsl:value-of select="DATAELEMENTS_strPageName" /></xsl:param>
             ...
             <!--<xsl:if test="$DATAELEMENTS_intDataElementType != 'PAGEBREAK' or $strMode != 'addPageBreak'">-->
                      ...
                      <hr/>
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td width="80%">                    
                                    <select size="1" name="DATAELEMENTS_intDataElementType" tabindex="6" class="uportal-input-text" onChange="document.frmaddedit_dataelements1.submit();">
                                                ...
                                                <!-- Form Link Start-->                                                
                                                <option value="FORM LINK">
                                                        <xsl:choose>
                                                        <xsl:when test="$DATAELEMENTS_intDataElementTypeSelected != 'null'">
                                                         <xsl:if test="$DATAELEMENTS_intDataElementTypeSelected = 'FORM LINK'">
                                                                <xsl:attribute name="selected">true</xsl:attribute> 
                                                         </xsl:if>
                                                        </xsl:when>

                                                        <xsl:when test="$DATAELEMENTS_intDataElementType = 'FORM LINK'">
                                                                <xsl:attribute name="selected">true</xsl:attribute> 
                                                        </xsl:when>   
                                                        </xsl:choose>
                            ...
                            <!-- ************** if the dataelement type is FORM LINK ****************************-->
                            <xsl:if test="$DATAELEMENTS_intDataElementTypeSelected = 'FORM LINK' or $DATAELEMENTS_intDataElementType = 'FORM LINK' and $DATAELEMENTS_intDataElementTypeSelected = 'null' or $DATAELEMENTS_intDataElementTypeSelected = 'null' and $strMode = 'newDEClicked'">
                                <!-- Channel functional name -->
                                <tr>
                                    <td width="20%" class="uportal-label">
                                       <xsl:value-of select="DATAELEMENTS_strChannelFunctionalNameDisplay" />:

                                    </td>
                                    <td width="80%">
                                       <xsl:choose>
                                       <xsl:when test="string-length($DATAELEMENTS_strChannelFunctionalName) != 0">
                                            <input type="text" name="DATAELEMENTS_strChannelFunctionalName" value="{$DATAELEMENTS_strChannelFunctionalName}" size="40" tabindex="9" class="uportal-input-text"/>                          
                                       </xsl:when>
                                       <xsl:otherwise>
                                            <input type="text" name="DATAELEMENTS_strChannelFunctionalName" value="" size="40" tabindex="9" class="uportal-input-text"/>                          
                                       </xsl:otherwise>
                                       </xsl:choose>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td width="20%" class="uportal-label">
                                       <xsl:value-of select="DATAELEMENTS_strPageNameDisplay" />:

                                    </td>
                                    <td width="80%">
                                       <xsl:choose>
                                       <xsl:when test="string-length($DATAELEMENTS_strPageName) != 0">
                                            <input type="text" name="DATAELEMENTS_strPageName" value="{$DATAELEMENTS_strPageName}" size="40" tabindex="9" class="uportal-input-text"/>                          
                                       </xsl:when>
                                       <xsl:otherwise>
                                            <input type="text" name="DATAELEMENTS_strPageName" value="" size="40" tabindex="9" class="uportal-input-text"/>                          
                                       </xsl:otherwise>
                                       </xsl:choose>
                                    </td>
                                </tr> 
                            ...
                            <xsl:choose>
                                ...
                                <xsl:otherwise>
                                    ...
                                    <tr>
                                        ...
                                        <!-- Default textbox -->
                                            <!-- set it to empty string if there is no value -->
                                            <xsl:if test="string-length($DATAELEMENTS_strDataElementDefault) = 0">
                                            <input type="text" name="DATAELEMENTS_strDataElementDefault" value="" size="10" tabindex="21" class="uportal-input-text"/>                          
                                            </xsl:if>
                                            <xsl:if test="string-length($DATAELEMENTS_strDataElementDefault) != 0">

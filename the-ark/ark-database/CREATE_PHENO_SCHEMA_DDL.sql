...
CREATE SCHEMA IF NOT EXISTS `pheno` DEFAULT CHARACTER SET latin1 ;
SHOW WARNINGS;
USE `study` ;
...
-- Table `pheno`.`status`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`status` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`status` (
  `ID` INT(11) NOT NULL ,
  `NAME` VARCHAR(20) NOT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `pheno`.`collection`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`collection` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`collection` (
  `ID` INT(11) NOT NULL ,
  `STUDY_ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `COLLECTION_STATUS_FK`
    FOREIGN KEY (`STATUS_ID` )
    REFERENCES `pheno`.`status` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `COLLECTION_STATUS_FK` ON `pheno`.`collection` (`STATUS_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`delimiter_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`delimiter_type` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`delimiter_type` (
  `ID` INT(11) NOT NULL ,
  `NAME` VARCHAR(20) NOT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `pheno`.`import_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`import_type` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`import_type` (
  `ID` INT(11) NOT NULL ,
  `NAME` VARCHAR(20) NOT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
...
-- -----------------------------------------------------
-- Table `pheno`.`collection_import`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`collection_import` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`collection_import` (
  `ID` INT(11) NOT NULL ,
  ...
  `UPDATE_USER_ID` VARCHAR(50) NULL DEFAULT NULL ,
  `UPDATE_TIME` DATETIME NULL DEFAULT NULL ,
  PRIMARY KEY (`ID`, `COLLECTION_ID`, `IMPORT_TYPE_ID`, `DELIMITER_TYPE_ID`) ,
  CONSTRAINT `COLLECTION_IMPORT_COLLECTION_FK`
    FOREIGN KEY (`COLLECTION_ID` )
    REFERENCES `pheno`.`collection` (`ID` )
    ON UPDATE NO ACTION,
  CONSTRAINT `COLLECTION_IMPORT_DELIMITER_TYPE_FK`
    FOREIGN KEY (`DELIMITER_TYPE_ID` )
    REFERENCES `pheno`.`delimiter_type` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `COLLECTION_IMPORT_IMPORT_TYPE_FK`
    FOREIGN KEY (`IMPORT_TYPE_ID` )
    REFERENCES `pheno`.`import_type` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `COLLECTION_IMPORT_COLLECTION_FK` ON `pheno`.`collection_import` (`COLLECTION_ID` ASC) ;

SHOW WARNINGS;
CREATE INDEX `COLLECTION_IMPORT_IMPORT_TYPE_FK` ON `pheno`.`collection_import` (`IMPORT_TYPE_ID` ASC) ;

SHOW WARNINGS;
CREATE INDEX `COLLECTION_IMPORT_DELIMITER_TYPE_FK` ON `pheno`.`collection_import` (`DELIMITER_TYPE_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`field_type`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field_type` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field_type` (
  `ID` INT(11) NOT NULL ,
  `NAME` VARCHAR(20) NOT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
...
-- Table `pheno`.`field`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field` (
  `ID` INT(11) NOT NULL ,
  `STUDY_ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `FIELD_FIELD_TYPE_FK`
    FOREIGN KEY (`FIELD_TYPE_ID` )
    REFERENCES `pheno`.`field_type` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `FIELD_FIELD_TYPE_FK` ON `pheno`.`field` (`FIELD_TYPE_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`field_data`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field_data` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field_data` (
  `ID` INT(11) NOT NULL ,
  `COLLECTION_ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `FIELD_DATA_COLLECTION_FK`
    FOREIGN KEY (`COLLECTION_ID` )
    REFERENCES `pheno`.`collection` (`ID` )
    ON UPDATE CASCADE,
  CONSTRAINT `FIELD_DATA_FIELD_FK`
    FOREIGN KEY (`FIELD_ID` )
    REFERENCES `pheno`.`field` (`ID` )
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;

SHOW WARNINGS;
CREATE INDEX `FIELD_DATA_FIELD_FK` ON `pheno`.`field_data` (`FIELD_ID` ASC) ;

SHOW WARNINGS;
CREATE INDEX `FIELD_DATA_COLLECTION_FK` ON `pheno`.`field_data` (`COLLECTION_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`field_data_log`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field_data_log` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field_data_log` (
  `ID` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `pheno`.`field_group`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field_group` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field_group` (
  `ID` INT(11) NOT NULL ,
...
-- -----------------------------------------------------
-- Table `pheno`.`field_groups`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`field_groups` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`field_groups` (
  `ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `FIELD_GROUPS_FIELD_FK`
    FOREIGN KEY (`FIELD_ID` )
    REFERENCES `pheno`.`field` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FIELD_GROUPS_FIELD_GROUP_FK`
    FOREIGN KEY (`FIELD_GROUP_ID` )
    REFERENCES `pheno`.`field_group` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `FIELD_GROUPS_FIELD_GROUP_FK` ON `pheno`.`field_groups` (`FIELD_GROUP_ID` ASC) ;

SHOW WARNINGS;
CREATE INDEX `FIELD_GROUPS_FIELD_FK` ON `pheno`.`field_groups` (`FIELD_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`file_format`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`file_format` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`file_format` (
  `ID` INT(11) NOT NULL ,
  `NAME` VARCHAR(20) NOT NULL ,
  PRIMARY KEY (`ID`) )
ENGINE = InnoDB
...
-- Table `pheno`.`upload`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`upload` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`upload` (
  `ID` INT(11) NOT NULL ,
  ...
  CONSTRAINT `UPLOAD_FILE_FORMAT_FK`
    FOREIGN KEY (`FILE_FORMAT_ID` )
    REFERENCES `pheno`.`file_format` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `UPLOAD_FILE_FORMAT_FK` ON `pheno`.`upload` (`FILE_FORMAT_ID` ASC) ;

SHOW WARNINGS;

-- -----------------------------------------------------
-- Table `pheno`.`upload_collection`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pheno`.`upload_collection` ;

SHOW WARNINGS;
CREATE  TABLE IF NOT EXISTS `pheno`.`upload_collection` (
  `ID` INT(11) NOT NULL ,
  ...
  `UPDATE_USER_ID` VARCHAR(50) NULL DEFAULT NULL ,
  `UPDATE_TIME` DATETIME NULL DEFAULT NULL ,
  PRIMARY KEY (`ID`, `UPLOAD_ID`, `COLLECTION_ID`) ,
  CONSTRAINT `UPLOAD_COLLECTION_COLLECTION_FK`
    FOREIGN KEY (`COLLECTION_ID` )
    REFERENCES `pheno`.`collection` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `UPLOAD_COLLECTION_UPLOAD_FK`
    FOREIGN KEY (`UPLOAD_ID` )
    REFERENCES `pheno`.`upload` (`ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;
...
SHOW WARNINGS;
CREATE INDEX `UPLOAD_COLLECTION_COLLECTION_FK` ON `pheno`.`upload_collection` (`COLLECTION_ID` ASC) ;

SHOW WARNINGS;
CREATE INDEX `UPLOAD_COLLECTION_UPLOAD_FK` ON `pheno`.`upload_collection` (`UPLOAD_ID` ASC) ;

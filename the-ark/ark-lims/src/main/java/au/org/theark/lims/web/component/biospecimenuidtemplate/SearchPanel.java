...
import au.org.theark.lims.web.component.biospecimenuidtemplate.form.SearchForm;
...
public class SearchPanel extends Panel {
	...
	public void initialisePanel() {
		SearchForm searchForm = new SearchForm(au.org.theark.core.Constants.SEARCH_FORM, (CompoundPropertyModel<BiospecimenUidTemplate>) containerForm.getModel(), arkCrudContainerVO, feedbackPanel);
		add(searchForm);
	}
}

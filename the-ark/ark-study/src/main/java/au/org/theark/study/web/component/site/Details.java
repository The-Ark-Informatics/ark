...
public class Details extends Panel {
	...
	public Details(String id, final WebMarkupContainer resultListContainer, FeedbackPanel feedBackPanel, WebMarkupContainer detailPanelContainer, WebMarkupContainer searchPanelContainer,

    ...
    where
        ...
        and (
            biocollect1_.BIOCOLLECTION_UID in (
...
select distinct biocollection_id from biospecimen where id in (328050, 328127, 328128, 328131, 328143, 328136, 328138, 328139, 328142, 328051);

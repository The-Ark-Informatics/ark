...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="inventory">
        <xsl:param name="TANK_intTankID">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_intTankID"/>
        </xsl:param>
        <xsl:param name="TANK_dtCommissionDate_Year">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtCommissionDate_Year"/>
        </xsl:param>
        <xsl:param name="TANK_dtCommissionDate_Day">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtCommissionDate_Day"/>
        </xsl:param>
        <xsl:param name="TANK_dtCommissionDate_Month">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtCommissionDate_Month"/>
        </xsl:param>
        <xsl:param name="TANK_dtDecommissionDate_Year">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtDecommissionDate_Year"/>
        </xsl:param>
        <xsl:param name="TANK_dtDecommissionDate_Day">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtDecommissionDate_Day"/>
        </xsl:param>
        <xsl:param name="TANK_dtDecommissionDate_Month">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtDecommissionDate_Month"/>
        </xsl:param>
        <xsl:param name="TANK_dtLastServiceDate_Year">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtLastServiceDate_Year"/>
        </xsl:param>
        <xsl:param name="TANK_dtLastServiceDate_Day">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtLastServiceDate_Day"/>
        </xsl:param>
        <xsl:param name="TANK_dtLastServiceDate_Month">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_dtLastServiceDate_Month"/>
        </xsl:param>
        <xsl:param name="TANK_intSiteID">
            <xsl:value-of select="/inventory/Selected/SITE/SITE_intSiteID"/>
        </xsl:param>
        <xsl:param name="TANK_strTankName">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_strTankName"/>
        </xsl:param>
        ...
        <xsl:param name="TANK_strStatus">
            <xsl:value-of select="/inventory/Selected/SITE/TANK/TANK_strStatus"/>
        </xsl:param>
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    <select name="TANK_strStatus" tabindex="5"
                                        ...
                                        <xsl:variable name="varSiteStatus">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_strStatus=$varSiteStatus">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="$varSiteStatus"/>
                                            </option>
                                        </xsl:for-each>
                                    </select>
                                </td>
                        ...
                        <xsl:when test="TANK_dtCommissionDate/@display_type='text'">
                            ...
                            <xsl:otherwise>
                                    <select name="TANK_dtCommissionDate_Day" tabindex="6"
                                        ...
                                        <xsl:variable name="varSiteCommissionDateDay">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtCommissionDate_Day = $varSiteCommissionDateDay">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="$varSiteCommissionDateDay"/>
                                            </option>
                                        </xsl:for-each>
                                    </select>
                                    <select name="TANK_dtCommissionDate_Month" tabindex="7"
                                        ...
                                        <xsl:variable name="varCommissionDateMonth">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtCommissionDate_Month = varCommissionDateMonth">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="."/>
                            ...
                            <tr>
                                ...
                                <td width="25%">
                                    ...
                                    <select name="TANK_dtLastServiceDate_Day" tabindex="9"
                                        ...
                                        <xsl:variable name="varLastServiceDateDay">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtLastServiceDate_Day = $varLastServiceDateDay">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="."/>
                                    ...
                                    <select name="TANK_dtLastServiceDate_Month" tabindex="10"
                                        ...
                                        <xsl:variable name="varLastServiceDateMonth">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtLastServiceDate_Month = $varLastServiceDateMonth">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="."/>
                                ...
                                <td width="25%">
                                    ...
                                    <select name="TANK_dtDecommissionDate_Day" tabindex="13"
                                        ...
                                        <xsl:for-each select="TANK_dtDecommissionDate_Day">
                                            <xsl:variable name="varDecommissionDateDay">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtDecommissionDate_Day = $varDecommissionDateDay">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="$varDecommissionDateDay"/>
                                            </option>
                                        </xsl:for-each>
                                    </select>
                                    <select name="TANK_dtDecommissionDate_Month" tabindex="14"
                                        ...
                                        <xsl:for-each select="TANK_dtDecommissionDate_Month">
                                            <xsl:variable name="varDecommissionDateMonth">
                                                <xsl:value-of select="."/>
                                            </xsl:variable>
                                            <option>
                                                <xsl:attribute name="value">
                                                ...
                                                <xsl:if test="$TANK_dtDecommissionDate_Month = $varDecommissionDateMonth">
                                                  <xsl:attribute name="selected"
                                                  >true</xsl:attribute>
                                                </xsl:if>
                                                <xsl:value-of select="$varDecommissionDateMonth"/>
                                            </option>
                                        </xsl:for-each>
                                    </select>
                                    </xsl:otherwise>

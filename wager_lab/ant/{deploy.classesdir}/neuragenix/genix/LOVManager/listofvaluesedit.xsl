			...
			<xsl:for-each select="searchResult" >
				<tr>
					<form method="post" action="{$baseActionURL}?current=editval">
						...
						<td class="uportal-text" width="30%">
						...
						<td class="uportal-text"><input class="uportal-button" type="submit" value="Update"/></td>
					</form>
				</tr>
			</xsl:for-each>
				<tr><td><hr/></td></tr>
				<tr>
					<form method="post" action="{$baseActionURL}?current=insertval">
						...
						<td class="uportal-text"><input type="submit" class="uportal-button" value="Insert"/></td>
                                ...
                                <tr>
                                    <form method="post" action="{$baseActionURL}?current=showlists">
                                        <td class="uportal-text"><input type="submit" class="uportal-button" value="&lt;Back"/></td>
                                    </form>

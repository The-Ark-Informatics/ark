    ...
    <xsl:template match="/">
            ...
            <xsl:for-each select="//MatchedRecord">
                ...
                <!-- Check if MatchRecord has the SAME ID as FOCUS ID, not sure if this necessary , ./MatchedData/*/@NAME = $strColName and-->
                    ...
                    <RPTY>
                        ...
                        <!-- ACCOUNT TYPE -->
                        <xsl:choose>
                        <xsl:when test="TableName = 'ACCT' and string-length(./MatchedData/*[@NAME='ACCT_INTRL_ID']) > 0">
                        ...
                        <!-- DERIVED ADDRESS -->
                        <xsl:when test="TableName = 'DERIVED_ADDRESS' and string-length( ./MatchedData/*[@NAME='DERVD_ADDR_SEQ_ID'] ) > 0">
                        ...
                        <!-- CORRESPONDENT BANK -->
                        <xsl:when test="TableName = 'CLIENT_BANK' and string-length( ./MatchedData/*[@NAME='INSTN_SEQ_ID'] ) > 0">
                        ...
                        <!-- CUSTOMER -->
                        <xsl:when test="TableName = 'CUST' and string-length( ./MatchedData/*[@NAME='CUST_INTRL_ID'] ) > 0">
                        ...
                        <!-- EMPLOYEE -->
                        <xsl:when test="TableName = 'EMP' and string-length( ./MatchedData/*[@NAME='EMP_INTRL_ID'] ) > 0">
                        ...
                        <!-- HOUSEHOLD -->
                        <xsl:when test="TableName = 'ACCT_GRP' and string-length( ./MatchedData/*[@NAME='ACCT_GRP_ID'] ) > 0">
                        ...
                        <!-- SECURITY -->
                        <xsl:when test="TableName = 'SCRTY' and string-length( ./MatchedData/*[@NAME='SCRTY_INTRL_ID'] ) > 0">
                        ...
                        <!-- INVESTMENT ADVISOR -->
                        <xsl:when test="TableName = 'NVSMT_MGR' and string-length( ./MatchedData/*[@NAME='NVSMT_MGR_INTRL_ID'] )">
                        ...
                        <!-- EXTERNAL -->
                        <xsl:when test="TableName = 'EXTERNAL_ENTITY' and string-length( ./MatchedData/*[@NAME='EXTRL_NTITY_SEQ_ID'] ) > 0">
                        ...
                        <!-- ORDER -->
                        <xsl:when test="TableName = 'ORDR' and string-length( $strRPID ) > 0">
                        ...
                        <xsl:when test="TableName = 'EXECUTION' and string-length( $strRPID ) > 0">
                        ...
                        <RCAS>
                            ...
                            <!-- INVESTMENT ADVISOR -->
                            <xsl:when test="TableName = 'NVSMT_MGR' and string-length( ./MatchedData/*[@NAME='NVSMT_MGR_INTRL_ID'] ) > 0">
		...
		<xsl:for-each select="MatchedRecord">
                            ...
                            <xsl:when test="TableName = 'ACCT_ADDR'">
								...
								<xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE2_TX'] ) > 0">, <xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE2_TX']"/>
								</xsl:if>
								<xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE3_TX'] ) > 0">, <xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE3_TX']"/>
								</xsl:if>
								<xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE4_TX'] ) > 0">, <xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE4_TX']"/>
								</xsl:if>
								<xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE5_TX'] ) > 0">, <xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE5_TX']"/>
								</xsl:if>
								<xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE6_TX'] ) > 0">, <xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE6_TX']"/>
								</xsl:if>
                                </RADD_strStreetName>
                            ...
                            <xsl:when test="TableName = 'CUST_ADDR'">
                                ...
                                <RADD_strType>Address</RADD_strType>
                                <RADD_strSubType><xsl:call-template name="get-address-type"><xsl:with-param name="strType"><xsl:value-of select="./MatchedData/*[@NAME='ADDR_USAGE_CD']"/></xsl:with-param></xsl:call-template></RADD_strSubType>
                                <RADD_strStreetName><xsl:value-of select="./MatchedData/*[@NAME='ADDR_STRT_LINE1_TX']"/><xsl:if test="string-length( ./MatchedData/*[@NAME='ADDR_STRT_LINE2_TX'] ) > 0">
                            ...
                            <xsl:when test="TableName = 'CUST_PHON'">
								...
								<RADD_strStreetName><xsl:value-of select="./MatchedData/*[@NAME='PHON_NB']"/><xsl:if test="string-length( ./MatchedData/*[@NAME='PHON_EXT_NB'] ) > 0">(<xsl:value-of select="./MatchedData/*[@NAME='PHON_EXT_NB']"/>)</xsl:if>
								</RADD_strStreetName>
                            </xsl:when>
                            <!-- EMPLOYEE -->

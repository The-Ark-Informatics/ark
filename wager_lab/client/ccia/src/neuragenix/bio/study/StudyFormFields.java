...
//------------------------ LOAD ADD STUDY -----------------------------------------
        ...
        hashAddStudyFormFields.put("strStudyName", "Project name");

        hashAddStudyFormFields.put("strStudyOwner", "Project owner");

        hashAddStudyFormFields.put("strStudyCode", "Project code");

        
        hashAddStudyFormFields.put("strStudyDesc" , "Project description");
...
// ----------------------- LOAD VIEW STUDY -----------------------------------------        
        ...
        hashViewStudyFormFields.put("strStudyName", "Project name");

        hashViewStudyFormFields.put("strStudyOwner", "Project owner");

        hashViewStudyFormFields.put("strStudyCode", "Project code");
   
        hashViewStudyFormFields.put("strStudyDesc" , "Project description");
...
// ------------ ADD THE SEARCH RESULTS FIELDS -------------------------------
        ...
        hashStudyResultsFormFields.put("strStudyName", "Project name");

        hashStudyResultsFormFields.put("strStudyOwner", "Project owner");

        hashStudyResultsFormFields.put("dtStudyStart", "Project date");
...
// --------- LOAD THE STUDY SEARCH SCREEN -----------------------
        ...
        hashStudySearchFormFields.put("strStudyName", "Project name");

        hashStudySearchFormFields.put("strStudyOwner", "Project owner");
...
// ---------- LOAD THE STUDY SURVEY SCREEN -----------------------------
        ...
        hashStudySurveyStudyFormFields.put("strStudyName", "Project name");

        hashStudySurveyStudyFormFields.put("strStudyOwner", "Project owner");

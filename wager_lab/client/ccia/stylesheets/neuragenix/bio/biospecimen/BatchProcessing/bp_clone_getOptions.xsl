...
function updateTray()
{
  ...
  <!-- 
	...
	<table width="100%">
        ...
        <span class="uportal-label">Cloning Sample ID :  </span> <span class="uportal-text"><xsl:value-of select="BIOSPECIMEN_strBiospecimenID" /></span><br />
        ...
        <table>
           <tr>   
              <td align="right">
                 <form name="CANCEL" action="{$baseActionURL}?module=core&amp;action=view_biospecimen&amp;BIOSPECIMEN_intBiospecimenID={$strBiospecimenID}" method="POST">

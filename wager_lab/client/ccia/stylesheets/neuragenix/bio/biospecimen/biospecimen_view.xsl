...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="/biospecimen">
        ...
        <xsl:param name="BIOSPECIMEN_Timestamp"><xsl:value-of select="BIOSPECIMEN_Timestamp"/></xsl:param>
        ...
        <xsl:param name="dtBiospecSampleDate"><xsl:value-of select="BIOSPECIMEN_dtBiospecSampleDate"/></xsl:param>
        <xsl:param name="strBiospecOtherID"><xsl:value-of select="BIOSPECIMEN_strOtherID"/></xsl:param>
        <xsl:param name="intInternalPatientID"><xsl:value-of select="BIOSPECIMEN_intPatientID"/></xsl:param>
        ...
        <xsl:param name="strBiospecCode"><xsl:value-of select="BIOSPECIMEN_strBiospecCode"/></xsl:param>
        <xsl:param name="strBiospecDescription"><xsl:value-of select="BIOSPECIMEN_strBiospecDescription"/></xsl:param>
        <xsl:param name="intDepth"><xsl:value-of select="BIOSPECIMEN_intDepth"/>=</xsl:param>
        <xsl:param name="strBiospecGestAt"><xsl:value-of select="BIOSPECIMEN_strBiospecGestAt"/></xsl:param>
        <xsl:param name="intBiospecNumCollected"><xsl:value-of select="BIOSPECIMEN_intBiospecNumCollected"/></xsl:param>
        <xsl:param name="intBiospecNumRemoved"><xsl:value-of select="BIOSPECIMEN_intBiospecNumRemoved"/></xsl:param>
        <xsl:param name="intBiospecVolRemoved"><xsl:value-of select="BIOSPECIMEN_intBiospecVolRemoved"/></xsl:param>
        <xsl:param name="intBiospecVolume"><xsl:value-of select="BIOSPECIMEN_intBiospecVolume"/></xsl:param>
        <xsl:param name="strBiospecSampleTypeSelected"><xsl:value-of select="BIOSPECIMEN_strBiospecSampleTypeSelected"/></xsl:param>
        <xsl:param name="flag"><xsl:value-of select="flag"/></xsl:param>
        <xsl:param name="strEncounter"><xsl:value-of select="strEncounter"/></xsl:param>
        <xsl:param name="intInvCellID"><xsl:value-of select="/biospecimen/inventory_info/CELL_intCellID"/></xsl:param>
        ...
        <xsl:param name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Year"><xsl:value-of select="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Year"/></xsl:param>
        <xsl:param name="strBiospecGrade"><xsl:value-of select="strBiospecGrade"/></xsl:param>
        ...
        <xsl:param name="strBiospecSpecies"><xsl:value-of select="strBiospecSpecies"/></xsl:param>
        <xsl:param name="intBiospecStudyID"><xsl:value-of select="BIOSPECIMEN_intStudyKey"/></xsl:param>
        <!-- Vial calculation -->
        <xsl:param name="VIAL_CALCULATION_intVialCalculationKey"><xsl:value-of select="VIAL_CALCULATION_intVialCalculationKey"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intClinicalStatCalc"><xsl:value-of select="VIAL_DETAILS_intClinicalStatCalc"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_flClinicalStatCalcMonths"><xsl:value-of select="VIAL_DETAILS_flClinicalStatCalcMonths"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intManualCellCount"><xsl:value-of select="VIAL_DETAILS_intManualCellCount"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intDilutionFactor"><xsl:value-of select="VIAL_DETAILS_intDilutionFactor"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intmLsSuspended"><xsl:value-of select="VIAL_DETAILS_intmLsSuspended"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intCellmL"><xsl:value-of select="VIAL_DETAILS_intCellmL"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intTotalCellCount"><xsl:value-of select="VIAL_DETAILS_intTotalCellCount"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intmLsResuspended"><xsl:value-of select="VIAL_DETAILS_intmLsResuspended"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_flmLsCollectionTube"><xsl:value-of select="VIAL_DETAILS_flmLsCollectionTube"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_flmLsAnticosgulant"><xsl:value-of select="VIAL_DETAILS_flmLsAnticosgulant"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intConcentration"><xsl:value-of select="VIAL_DETAILS_intConcentration"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_flTotalmLsBM"><xsl:value-of select="VIAL_DETAILS_flTotalmLsBM"/></xsl:param>
        <xsl:param name="VIAL_DETAILS_intSecondLook"><xsl:value-of select="VIAL_DETAILS_intSecondLook"/></xsl:param>
        ...
        <table width="100%">
            <tr valign="top">
                ...
                <td width="80%">
                    <table width="100%">
                        <tr>
                            <td class="uportal-channel-subtitle">View sample</td>
                            <td align="right">
                        ...
                        <tr>
                            <td>
                                ...
                                <form action="{$baseActionURL}" method="POST">
                                    ...
                                    <input type="submit" value="Add sub sample" tabindex="180"
                            ...
                            <td>
                                ...
                                <form action="{$baseActionURL}" method="POST">
                                    ...
                                    <input type="hidden" name="module" value="core"/>
                                    <input type="submit" value="Clone" tabindex="181"
                                        class="uportal-button"/>
                                </form>
                            </td>
                            <td>
                                ...
                                <xsl:if test="biospecimen_modules/batchCloning='true'">
                                    <form
                                        ...
                                        <input type="submit" class="uportal-button"
                                            value="Batch Clone" tabindex="182"/>
                                    </form>
                                </xsl:if>
                            </td>
                            <td valign="top">
                                ...
                                <xsl:if test="biospecimen_modules/bioanalysis='true'">
                                    <form action="{$baseActionURL}" method="POST">
                                        ...
                                        <input type="hidden" name="module" value="core"/>
                                        <input type="button" value="Analysis results" tabindex="183"
                                            class="uportal-button"
                                    ...
                                    <xsl:when test="$intVialKey  ='-1'">
                                        <form action="{$baseActionURL}?current=vial_calculation"
                                            ...
                                            <input type="submit" name="vial_calculation"
                                                value="Vial Calculation" tabindex="184"
                                                class="uportal-button"/>
                                        </form>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <form action="{$baseActionURL}?" method="POST">
                                            ...
                                            <input type="submit" name="vial_calculation_history"
                                                value="Vial Calculation History " tabindex="185"
                                                class="uportal-button"/>
                                        </form>
                                    </xsl:otherwise>
                                </xsl:choose>
                                ...
                                <xsl:if test="biospecimen_modules/studySmartforms='true'">
                                    <form action="{$baseActionURL}" method="POST">
                                        ...
                                        <input type="hidden" name="intStudyID"
                                            value="{$intBiospecStudyID}"/>
                                        <input type="button" value="Study results" tabindex="186"
                                            class="uportal-button"
                            ...
                            <td>
                                <form action="{$baseActionURL}?ATTACHMENTS_domainName=Biospecimen"
                                    ...
                                    <input type="submit" value="Attachments" tabindex="187"
                                        class="uportal-button"/>
                                </form>
                            </td>
                            <td/>
                    ...
                    <form name="biospecimen_form"
                        ...
                        <table width="100%">
                            ...
                            <!-- Row0: strBiospecimenID, strParent -->
                            <tr>
                            ...
                            <tr>
                                ...
                                <td width="26%" id="neuragenix-form-row-input-input"
                                    class="uportal-label">
                                    <select name="BIOSPECIMEN_strSampleType" tabindex="1"
                            ...
                            <!-- Row3: intStudyKey dtExtractedDate -->
                            <tr>
                                <td width="1%" id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text">
                                    <xsl:if
                                ...
                                <td width="25%" valign="top">
                                    ...
                                    <xsl:choose>
                                        <xsl:when test="contains($flag,'true')">
                                            <input type="checkbox" name="isFlagged" tabindex="38"
                                                checked="checked" value="true" class="uportal-text"
                                            />
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <input type="checkbox" tabindex="38" name="isFlagged"
                            ...
                            <tr>
                                ...
                                <td width="26%" id="neuragenix-form-row-input-label" class="uportal-label" valign="top">
                                    <xsl:value-of select="BIOSPECIMEN_intClinicalAge"/></td>
                                <td width="5%" valign="top"/>
                                <td width="1%" id="neuragenix-form-row-input-label-required" class="neuragenix-form-required-text" valign="top"/>
                                <td width="18%" id="neuragenix-form-row-input-label" class="uportal-label" valign="top">
                                    <xsl:value-of select="BIOSPECIMEN_strCommentsDisplay"/>: </td>
                                <td width="25%" valign="top">
                                    <textarea name="BIOSPECIMEN_strComments" rows="4" cols="40" tabindex="39" class="uportal-input-text">
                            ...
                            <tr>
                                ...
                                <td align="right" colspan="4">
                                    <input type="hidden" name="BIOSPECIMEN_intCellID"
                                        value="{$intInvCellID}"/>
                                    <input type="submit" name="save" value="Save Sample"
                        ...
                        <table width="100%">
                            ...
                            <tr>
                                ...
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="inventory_info/SITE_strTitleDisplay"/>: </td>
                                ...
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="inventory_info/TRAY_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                            ...
                            <tr>
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label">
                                    <xsl:value-of select="inventory_info/TANK_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                            ...
                            <tr>
                                <td id="neuragenix-form-row-input-label-required"
                                    class="neuragenix-form-required-text"/>
                                <td id="neuragenix-form-row-input-label" class="uportal-label"> <xsl:value-of select="inventory_info/BOX_strTitleDisplay"/>: </td>
                                <td class="uportal-text">
                        ...
                        <table width="100%">
                            ...
                            <xsl:for-each select="search_trans">
                                ...
                                <tr>
                                    ...
                                    <td width="18%" id="neuragenix-form-row-input-label"
                                        class="uportal-label">
                                        <!-- assigned study label --> 
                                        Project Assigned<xsl:value-of select="BIOSPECIMEN_intStudyKeyDisplay"/>: </td>
                                    <td width="26%" class="uportal-input-text"
                                        id="neuragenix-form-row-input-input">
                                        <!-- assigned study -->
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td width="26%" id="neuragenix-form-row-input"
                                        ...
                                        <select name="BIOSPECIMEN_TRANSACTIONS_strCollaborator"
                                            tabindex="60" class="uportal-input-text">
                                            <xsl:for-each
                                                select="BIOSPECIMEN_TRANSACTIONS_strCollaborator">
                                                <option>
                                                  <xsl:attribute name="value">
                                ...
                                <tr>
                                    ...
                                    <td width="26%" id="neuragenix-form-row-input" class="uportal-label">
                                        ...
                                        <xsl:choose>
                                        <xsl:when test="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate/@display_type='dropdown'">
                                            <select name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Day" tabindex="61"
                                                    class="uportal-input-text">
                                            ...
                                            <select name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Month" tabindex="62"
                                                    class="uportal-input-text">
                                          ...
                                          <xsl:otherwise>
                                            <input type="text" name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Day" size="2" tabindex="60" class="uportal-input-text">
                                                        <xsl:attribute name="value"><xsl:value-of select="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Day"/></xsl:attribute>
                                            </input>
                                             <input type="text" name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Month" size="2" tabindex="62" class="uportal-input-text">
                                                        <xsl:attribute name="value"><xsl:value-of select="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Month"/></xsl:attribute>
                                            </input>

                                          </xsl:otherwise>
                                          </xsl:choose>
                                    
                                            <input type="text" name="BIOSPECIMEN_TRANSACTIONS_dtTransactionDate_Year" size="5" tabindex="64" class="uportal-input-text">
                                                    <xsl:attribute name="value">
                                ...
                                -->
                                    ...
                                    <td width="26%" id="neuragenix-form-row-input"
                                        ...
                                        <select name="BIOSPECIMEN_TRANSACTIONS_strTreatment"
                                            tabindex="66" class="uportal-input-text">
                                            <xsl:for-each
                                ...
                                <tr>
                                    ...
                                    <td width="26%" class="uportal-label"
                                        ...
                                        <input type="text"
                                            ...
                                            tabindex="68" class="uportal-input-text"
                                            style="text-align: right"/>
                                        <select name="BIOSPECIMEN_TRANSACTIONS_strUnit"
                                            tabindex="70" class="uportal-input-text">
                                    ...
                                    <td width="26%" class="uportal-label"
                                        ...
                                        <textarea name="BIOSPECIMEN_TRANSACTIONS_strReason" rows="4"
                                            cols="25" class="uportal-input-text" tabindex="72">
                                ...
                                <tr>
                                    ...
                                    <td width="26%" class="uportal-label"
                                        ...
                                        <select name="BIOSPECIMEN_TRANSACTIONS_strOwner"
                                            tabindex="74" class="uportal-input-text">
                                ...
                                <tr>
                                    ...
                                    <td width="26%" class="uportal-label"
                                        ...
                                        <select name="BIOSPECIMEN_TRANSACTIONS_intStudyKey"
                                            tabindex="76" class="uportal-input-text">
                                    ...
                                    <td width="26%" class="uportal-text"
                                        ...
                                        <select name="BIOSPECIMEN_TRANSACTIONS_strStatus"
                                            tabindex="78" class="uportal-input-text">
                                            <xsl:for-each
                                ...
                                <tr>
                                    ...
                                    <td width="10%" class="uportal-label">
                                        <input type="submit" name="save_quantity"
                                            value="Save Quantity" tabindex="80"
                                            class="uportal-button"
                        ...
                        <tr>
                            <td>
                                ...
                                <form action="{$baseActionURL}" method="POST">
                                    ...
                                    <input type="hidden" name="module" value="core"/>
                                    <input type="hidden" name="action" value="add_biospecimen"/>
                                    <input type="submit" value="Add sub sample" tabindex="286"
                                        class="uportal-button"/>
                                </form>
                            </td>
                            <td>
                                ...
                                <form action="{$baseActionURL}" method="POST">
                                    ...
                                    <input type="hidden" name="action" value="clone_biospecimen"/>
                                    <input type="hidden" name="module" value="core"/>
                                    <input type="submit" value="Clone" tabindex="287"
                                        class="uportal-button"/>
                                </form>
                            </td>
                            <td>
                                ...
                                <xsl:if test="biospecimen_modules/batchCloning='true'">
                                    <form
                                        ...
                                        method="post">
                                        <input type="submit" class="uportal-button"
                                            value="Batch Clone" tabindex="288"/>
                                    </form>
                                </xsl:if>
                            </td>
                            <td valign="top">
                                ...
                                <xsl:if test="biospecimen_modules/bioanalysis='true'">
                                    <form action="{$baseActionURL}" method="POST">
                                        ...
                                        <input type="hidden" name="action" value="biospecimen_study"/>
                                        <input type="hidden" name="module" value="core"/>
                                        <input type="button" value="Analysis results" tabindex="289"
                                            class="uportal-button"
                                            onclick="javascript:jumpTo('{$smartformChannelURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab={$smartformChannelTabOrder}&amp;domain=Bioanalysis&amp;participant={$intBiospecimenID}&amp;intStudyID={$intBiospecStudyID}&amp;strcurrent=biospecimen_view&amp;intInternalPatientID={$intInternalPatientID}&amp;BIOSPECIMEN_intBiospecimenID={$intBiospecimenID}&amp;strOrigin=biospecimen_view&amp;title={$strBiospecimenID}&amp;var1={$strBiospecSampleTypeSelected}&amp;var2={$dtBiospecSampleDate}')"
                                        />
                                    </form>
                                    ...
                                    <xsl:when test="$intVialKey  ='-1'">
                                        <form action="{$baseActionURL}?current=vial_calculation"
                                            ...
                                            <input type="hidden" name="BIOSPECIMEN_dtExtractedDate"
                                                value="{$BIOSPECIMEN_dtExtractedDate}"/>
                                            <input type="submit" name="vial_calculation"
                                                value="Vial Calculation" tabindex="290"
                                                class="uportal-button"/>
                                        </form>
                                    </xsl:when>
                                    <xsl:otherwise>
                                        <form action="{$baseActionURL}?" method="POST">
                                            ...
                                            <input type="hidden" name="action"
                                                value="vial_calculation_history"/>
                                            <input type="submit" name="vial_calculation_history"
                                                value="Vial Calculation History " tabindex="291"
                                                class="uportal-button"/>
                                        </form>
                                    </xsl:otherwise>
                                </xsl:choose>
                            ...
                            <td>
                                <xsl:if test="biospecimen_modules/studySmartforms='true'">
                                    <form action="{$baseActionURL}" method="POST">
                                        ...
                                        <input type="hidden" name="intStudyID"
                                            value="{$intBiospecStudyID}"/>
                                        <input type="button" value="Study results" tabindex="292"
                                            class="uportal-button"
                                            onclick="javascript:jumpTo('{$smartformChannelURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab={$smartformChannelTabOrder}&amp;domain=Biospecimen&amp;participant={$intBiospecimenID}&amp;intStudyID={$intBiospecStudyID}&amp;strcurrent=biospecimen_view&amp;intInternalPatientID={$intInternalPatientID}&amp;intBiospecimenID={$intBiospecimenID}&amp;strOrigin=biospecimen_view&amp;title={$strBiospecimenID}&amp;var1={$strBiospecSampleTypeSelected}&amp;var2={$dtBiospecSampleDate}')"
                                        />
                                    </form>
                            ...
                            <td>
                                <form action="{$baseActionURL}?ATTACHMENTS_domainName=Biospecimen"
                                    ...
                                    <input type="hidden" name="intInternalPatientID"
                                        value="{$intInternalPatientID}"/>
                                    <input type="hidden" name="module" value="Attachments"/>
                                    <input type="submit" value="Attachments" tabindex="293"
                                        class="uportal-button"/>
                                </form>
                            </td>
                            <td/>

...
<xsl:param name="formParams">current=patient_admissions&amp;ADMISSIONS_intPatientID=<xsl:value-of select="PATIENT_intInternalPatientID" /></xsl:param>   
...
<xsl:template match='patient'>
	...
	<table width="100%">
		<tr>
                    <td class="uportal-channel-subtitle" align="left">
			<a href="{$baseActionURL}?uP_root=root&amp;action=view_patient&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}">
                    ...
                    <td class="uportal-channel-subtitle" align="right">
                        <span class="neuragenix-form-required-text">
                            History
                        </span>    
                        &#160;|&#160;
                        <a href="{$baseActionURL}?uP_root=root&amp;action=consent&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}">
                            Consent
                        </a>
                        &#160;|&#160;
                        
                        <a href="{$baseActionURL}?uP_root=root&amp;action=appointments&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}">

                            Follow&#160;Up
                        </a>
                        &#160;|&#160;
                        <a href="{$biospecimenURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab={$biospecimenTab}&amp;intInternalPatientID={$PATIENT_intInternalPatientID}&amp;current=biospecimen_search&amp;submit=intInternalPatientID&amp;currentPage=patient_results">
                            Sample
                        </a>
                        &#160;|&#160;
                        <a href="{$baseActionURL}?uP_root=root&amp;action=notes&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}">
                            Notes
                        </a>
                        &#160;|&#160;
                        <a href="{$baseActionURL}?uP_root=root&amp;action=attachments&amp;PATIENT_intInternalPatientID={$PATIENT_intInternalPatientID}">
                            Attachments
                        </a>
                         &#160;&#160;&#160;
...
// Long's script         
 ...
 function submitSelected(){
    document.diagnosisForm.action.value = document.diagnosisForm.action.value + '&amp;diagnosisSelected=true';
    document.diagnosisForm.diagnosisSubmit.value = "true";
...
function cancelSelected(){
    ...
    document.diagnosisForm.diagnosisSubmit.value = "false";
    document.diagnosisForm.submit();
			...
			Choose diagnosis<br/><hr/>
                ...
                <tr>
                    ...
                    <xsl:for-each select="diagnosis">
                        ...
                        <span id="diagnosis_{$DIAGNOSIS_intDiagnosisKey}" keyValue="{$DIAGNOSIS_intDiagnosisKey}"
                            nameValue="{$DIAGNOSIS_strDiagnosisName}" codeValue="{$DIAGNOSIS_strEPCCCode}" 
                            parentValue="{$DIAGNOSIS_intParentKey}">
                    ...
                    <form name="diagnosisForm" action="{$baseActionURL}?uP_root=root&amp;action=diagnosisSelected" method="post">
<!--                    <form name="diagnosisForm" action="{$smartformURL}?uP_root=root&amp;uP_sparam=activeTab&amp;activeTab={$smartformTab}&amp;" method="post"-->
                    ...
                    -->
                        ...
                        <input type="hidden" name="diagnosisSubmit"/>
                    </form>
        ...
        <table width="100%">
            ...
            <tr>
                <td align="left">
                        <input type="hidden" name="editAdmissionSelected" value="{$editAdmissionSelected}"/>
                        <input type="button"  name="cancelSelected" value="Cancel" onclick="javascript:cancelSelected()" class="uportal-button" />
                </td>
                <td align="right">
                   <form action="{$baseActionURL}?uP_root=root&amp;action=admissions" method="POST">
...
<!--                        <input type="button"  name="diagnosisSelected" value="Submit" onclick="javascript:submitSelected('{$currentField}')" class="uportal-button" /-->
                        <input type="button"  name="diagnosisSelected" value="Submit" onclick="javascript:submitSelected()" class="uportal-button" /> 
                   </form>
                </td>
            </tr>
        </table>

					...
					<table cellpadding="0" cellspacing="0" width="250" border="0">
						...
						<tr valign="top">
							<td align="left">
								...
								<xsl:variable name="PATIENT_strHospitalUR"><xsl:value-of select="/body/search/PATIENT_strHospitalUR"/></xsl:variable> 
								...
								<xsl:variable name="PATIENT_dtDob_Year">
									<xsl:value-of select="/body/search/PATIENT_dtDob_Year"/>
										...
										<xsl:if test="$disable-PATIENT_strHospitalUR != 'true'">
                                                                                    <tr class="funcpanel_content">
                                                                                            <td class="funcpanel_left_border">&#160;</td>
                                                                                            <td class="form_label"><xsl:value-of select="/body/search/PATIENT_strHospitalURDisplay"/>&#160;:</td>
                                                                                            <td>&#160;</td>
                                                                                            <td><input class="funcpanel_form" type="text" value="{$PATIENT_strHospitalUR}" tabindex="2" name="PATIENT_strHospitalUR" size="20"/></td>
                                                                                            <td class="funcpanel_right_border">&#160;</td>
                                                                                    </tr>
                                                                                    <tr class="funcpanel_content">
                                                                                            <td class="funcpanel_content_spacer" colspan="5"><img width="1" height="4" src="{$spacerImagePath}"/></td>
										...
										<xsl:if test="$disable-PATIENT_strSurname != 'true'">
                                                                                    <tr class="funcpanel_content">
                                                                                            ...
                                                                                            <td>&#160;</td>
                                                                                            <td><input class="funcpanel_form" type="text" value="{$PATIENT_strSurname}" tabindex="3" name="PATIENT_strSurname" size="20"/></td>
                                                                                            <td class="funcpanel_right_border">&#160;</td>
                                                                                    </tr>
                                                                                    <tr class="funcpanel_content">
                                                                                            <td class="funcpanel_content_spacer" colspan="5"><img width="1" height="4" src="{$spacerImagePath}"/></td>
                                                                                ...
                                                                                <xsl:if test="$disable-PATIENT_strFirstName != 'true'">
                                                                                    <tr class="funcpanel_content">
                                                                                            ...
                                                                                            <td>&#160;</td>
                                                                                            <td><input class="funcpanel_form" type="text" value="{$PATIENT_strFirstName}" tabindex="4" name="PATIENT_strFirstName" size="20"/></td>
                                                                                            <td class="funcpanel_right_border">&#160;</td>
                                                                                    </tr>
                                                                                    <tr class="funcpanel_content">
                                                                                            <td class="funcpanel_content_spacer" colspan="5"><img width="1" height="4" src="{$spacerImagePath}"/></td>
                                                                                            ...
                                                                                            <td>
                                                                                                    <xsl:choose>
                                                                                                            <xsl:when test="PATIENT_dtDob/@display_type='dropdown'">
                                                                                                                    <select name="PATIENT_dtDob_Day" tabindex="5">
                                                                                                                            <option value=""/>
                                                                                                                            <xsl:for-each select="/body/search/PATIENT_dtDob_Day">
                                                                                                                                    <option>
                                                                                                                    ...
                                                                                                                    <select name="PATIENT_dtDob_Month" tabindex="6">
                                                                                                                            <option value=""/>
                                                                                                                            <xsl:for-each select="/body/search/PATIENT_dtDob_Month">
                                                                                                                                    <option>
                                                                                                                                            <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                                                                                            <xsl:if test="@selected = '1'">
                                                                                                                                                    <xsl:attribute name="selected">true</xsl:attribute>
                                                                                                            ...
                                                                                                            <!-- when it is a text-->
                                                                                                            <xsl:otherwise>
                                                                                                                    <input class="funcpanel_form" type="text" name="PATIENT_dtDob_Day" size="2" tabindex="5">
                                                                                                                            <xsl:attribute name="value"><xsl:value-of select="/body/search/PATIENT_dtDob_Day"/></xsl:attribute>
                                                                                                                    </input>
                                                                                                                    <input class="funcpanel_form" type="text" name="PATIENT_dtDob_Month" size="2" tabindex="6">
                                                                                                                            <xsl:attribute name="value"><xsl:value-of select="/body/search/PATIENT_dtDob_Month"/></xsl:attribute>
                                                                                                                    </input>
                                                                                                            </xsl:otherwise>
                                                                                                    </xsl:choose>
                                                                                                    <input class="funcpanel_form" type="text" name="PATIENT_dtDob_Year" size="6" tabindex="7">
                                                                                ...
                                                                                <xsl:if test="$disable-PATIENT_strProtocol != 'true'">
                                                                                    <tr class="funcpanel_content">
                                                                                            <td class="funcpanel_left_border">&#160;</td>
                                                                                            <td class="form_label"><xsl:value-of select="/body/search/PATIENT_strProtocolDisplay"/>&#160;:</td>
                                                                                            <td>&#160;</td>
                                                                                            <td>
                                                                                            </td>
                                                                                            <td class="funcpanel_right_border">&#160;</td>
                                                                                ...
                                                                                <xsl:if test="$disable-PATIENT_strProtocol != 'true'">
                                                                                    <tr class="funcpanel_content">
                                                                                            ...
                                                                                            <td align="center" valign="center">
                                                                                                    <select class="funcpanel_form" name="PATIENT_strProtocol" tabindex="8">
                                                                                                            <xsl:for-each select="/body/search/PATIENT_strProtocol">
                                                                                                                    <option>
                                                                                                                            <xsl:attribute name="value"><xsl:value-of select="."/></xsl:attribute>
                                                                                                                            <xsl:if test="@selected = '1'">
                                                                                                                                    <xsl:attribute name="selected">true</xsl:attribute>
											...
											<td class="funcpanel_footer" align="right" colspan="3" width="100%">
												<input class="submit_image_button" type="image" src="{$buttonImagePath}/search_enabled.gif" tabindex="9" name="submit" value="Search"
								...
								<tr valign="top">
									<td align="left">
										<table class="funcpanel" cellpadding="0" cellspacing="0" border="0" width="100%">
											...
											<tr class="funcpanel_content">
												<td class="funcpanel_left_border">&#160;</td>
												<td class="form_label"><xsl:value-of select="/body/patient/PATIENT_strHospitalURDisplay"/>&#160;:</td>
												<td>&#160;</td>
												<td><xsl:value-of select="/body/patient/PATIENT_strHospitalUR"/></td>
												<td class="funcpanel_right_border">&#160;</td>
											</tr>
											-->
											<tr class="funcpanel_content">
						...
						<xsl:choose>
							...
							<xsl:when test="string-length( /body/patient/PATIENT_intInternalPatientID ) > 0 and count ( /body/patient/smartforms/study ) > 0">

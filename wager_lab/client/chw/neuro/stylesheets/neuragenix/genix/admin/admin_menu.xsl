...
//	}
	...
	<tr valign="top">
		<td id="neuragenix-border-right" width="15%" class="uportal-channel-subtitle">
			...
			<br></br>
                        <a href="{$baseActionURL}?current=report_comments">Manage Report Comments</a>
                        <br></br>
			...
			<!-- 
                        ...
                        -->                        
			<a href="{$baseActionURL}?current=upload_templates">Upload Templates</a>
                        <br></br>
                        <a href="{$baseActionURL}?current=add_doctor">Add/Modify Doctor Details</a>
		</td>
		<td width="5%"></td>
		<td width="80%">
				<xsl:apply-templates/>

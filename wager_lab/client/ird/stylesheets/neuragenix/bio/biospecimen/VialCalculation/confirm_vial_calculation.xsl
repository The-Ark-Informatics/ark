        ...
        <form name="myForm" action="{$baseActionURL}?current=vial_calculation" method="post">
            <table width="100%">
                <tr>
                    ...
                    <td width="25%">
                        <select name="VIAL_CALCULATION_dtDateOfFirstDiagnosis_Day" tabindex="1" class="uportal-input-text" disabled="true">
                            <option></option>
                        ...
                        <select name="VIAL_CALCULATION_dtDateOfFirstDiagnosis_Month" tabindex="2" class="uportal-input-text" disabled="true">
                            <option></option>
                        ...
                        <input readonly="true" type="text" name="VIAL_CALCULATION_dtDateOfFirstDiagnosis_Year" value="" size="4" tabindex="3" class="uportal-input-text">
                ...
                <tr>
                    ...
                    <td width="25%">
                        <select name="VIAL_CALCULATION_strSampleType" tabindex="4" class="uportal-input-text" disabled="true">
                ...
                <tr>
                    ...
                    <td width="25%">
                        <select name="VIAL_CALCULATION_intConcentration" tabindex="5" class="uportal-input-text" disabled="true">
                ...
                <tr>
                    ...
                    <td width="25%">
                        <xsl:choose > 
                            ...
                            <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intManualCellCount" value="{$VIAL_CALCULATION_intManualCellCount}" size="12" tabindex="6" class="uportal-input-text" />
                         </xsl:when>
                            <xsl:otherwise>   
                                <input type="text" style="text-align: right" name="VIAL_CALCULATION_intManualCellCount" value="0" size="12" tabindex="6" class="uportal-input-text"  readonly="true"/>
                            </xsl:otherwise>
                        </xsl:choose>
                    ...
                    <td width="25%">
                        <xsl:choose>
                            <xsl:when test="string($VIAL_CALCULATION_intDilutionFactor)">
                                <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intDilutionFactor" value="{$VIAL_CALCULATION_intDilutionFactor}" size="12" tabindex="7" class="uportal-input-text" />
                            </xsl:when>
                            <xsl:otherwise>
                                <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intDilutionFactor" value="0" size="12" tabindex="7" class="uportal-input-text" />
                            </xsl:otherwise>
                            </xsl:choose>
                    </td>
                    <td width="8%"></td>
                    ...
                    <td width="25%">
                        <xsl:choose>
                            <xsl:when test="string($VIAL_CALCULATION_flmLsSuspended)">
                                    <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flmLsSuspended" value="{$VIAL_CALCULATION_flmLsSuspended}" size="12" tabindex="8" class="uportal-input-text" />
                            </xsl:when>
                            <xsl:otherwise>
                                <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flmLsSuspended" value="0" size="12" tabindex="8" class="uportal-input-text" />    
                            </xsl:otherwise>
                            </xsl:choose>
                    </td>
                    <td width="8%"></td>
                ...
                <tr>
                    ...
                    <td width="25%">
                        ...
                        <select disabled="true" name="VIAL_CALCULATION_strCollectionTube" tabindex="16" class="uportal-input-text" onchange="javascript:setValueForAnticosgulant(document.myForm.VIAL_CALCULATION_strCollectionTube.options[document.myForm.VIAL_CALCULATION_strCollectionTube.selectedIndex].text)">
                ...
                <tr>
                    ...
                    <td width="25%">
                        ...
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flmLsCollectionTube" value="{$VIAL_CALCULATION_flmLsCollectionTube}" size="17" tabindex="17" class="uportal-input-text" />
                            </xsl:when>
                            <xsl:otherwise>
                                <input  readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flmLsCollectionTube" value="0" size="17" tabindex="17" class="uportal-input-text" />
                            </xsl:otherwise>
                            </xsl:choose>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <xsl:choose>
                         <xsl:when test="string($VIAL_CALCULATION_intVialStored)">
                            <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intVialStored" value="{$VIAL_CALCULATION_intVialStored}" size="12" tabindex="9" class="uportal-input-text" />
                        </xsl:when>
                            <xsl:otherwise>
                                <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intVialStored" value="0" size="12" tabindex="9" class="uportal-input-text" />
                                </xsl:otherwise>
                            </xsl:choose>
                    </td>
                    <td width="8%"></td>
                    ...
                    <td width="25%">
                        ...
                        <input  readonly="true" type="text"  style="text-align: right" name="VIAL_CALCULATION_flmLsAnticosgulant" value="0.8" size="12" tabindex="18" class="uportal-input-text" />
                        </xsl:if>
                        <xsl:if test="string-length($VIAL_CALCULATION_flmLsAnticosgulant) > 0"> 
                            <input  readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flmLsAnticosgulant" value="{$VIAL_CALCULATION_flmLsAnticosgulant}" size="12" tabindex="18" class="uportal-input-text" />
                        </xsl:if> 
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intMRDWash" size="12" tabindex="10" class="uportal-input-text">
                            <xsl:choose>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intMRDRNA" size="12" tabindex="11" class="uportal-input-text">
                            <xsl:choose>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flSampleWeighting" value="{$VIAL_CALCULATION_flSampleWeighting}" size="12" tabindex="9" class="uportal-input-text" />
                    </td>
                </tr>
                  ...
                  <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intPlasma" size="12" tabindex="12" class="uportal-input-text">
                            <xsl:choose>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intGDNA" size="12" tabindex="13" class="uportal-input-text">
                            <xsl:choose>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_intSecondLook" value="{$VIAL_CALCULATION_intSecondLook}" size="12" tabindex="19" class="uportal-input-text" />
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_strClinicalStatus" size="12" tabindex="14" class="uportal-input-text">
                            <xsl:choose>
                ...
                <tr>
                    ...
                    <td width="25%">
                        <input readonly="true" type="text" style="text-align: right" name="VIAL_CALCULATION_flSurvivalPeriod" size="12" tabindex="15" class="uportal-input-text">
                            <xsl:choose>
            ...
            <table width="100%">
                <tr>
                    <td>
                        ...
                        <!--<input type="button" name="perform_calc" tabindex="26" value="Perform calculation" class="uportal-button" onclick="javascript:document.myForm.action.value='perform_calculation';document.myForm.submit();"/>
                        -->
                        <!--
                        <xsl:if test="$strErrorMessage='Calculation performed'">
                            
                            <input type="submit" name="confirm_vial_calculation" tabindex="27" value="Confirm Vial Calculation" class="uportal-button"
                                onclick="javascript:document.myForm.action.value='confirm_vial_calculation'; document.myForm.submit();"/>
                        </xsl:if>
                        -->

                        
                            
                        <input type="button" name="generate_subbiospecimen" tabindex="27" value="Generate sub-specimens" class="uportal-button"
                                  onclick="javascript:document.myForm.action.value='get_allocation_option'; document.myForm.submit();"/>

...
public class RoundedRectangleView extends VertexView {

	public static RoundedRectangleRenderer renderer = new RoundedRectangleRenderer();

	public RoundedRectangleView(Object cell, JGraph graph, CellMapper cm) {
		super(cell, graph, cm);
	}
	...
	public static class RoundedRectangleRenderer extends VertexRenderer {

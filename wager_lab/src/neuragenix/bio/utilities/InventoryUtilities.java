...
public class InventoryUtilities
{
   ...
   public static int getSiteKeyforBiospecimen(int intBiospecimenKey) {
    ...
    query.setField("SITE_intSiteID", null);
   ...
   public static int getSiteKeyforTray(int intTrayKey) {
	   DALQuery query = new DALQuery();
	   int intReturnValue;
	   try {
       ...
       query.setWhere(null, 0, "TRAY_intTrayID", "=", intTrayKey + "", 0, DALQuery.WHERE_HAS_VALUE);
   ...
   public static int getSiteKeyforBox(int intBoxKey) {
	   DALQuery query = new DALQuery();
	   int intReturnValue;
	   try {
       ...
       query.setDomain("TANK", "BOX_intTankID", "TANK_intTankID", "INNER JOIN");
       query.setDomain("SITE", "TANK_intSiteID", "SITE_intSiteID", "INNER JOIN");
       query.setWhere(null, 0, "BOX_intBoxID", "=", intBoxKey + "", 0, DALQuery.WHERE_HAS_VALUE);
   ...
   public static int getSiteKeyforTank(int intTankKey) {
       ...
       query.setDomain("SITE", "TANK_intSiteID", "SITE_intSiteID", "INNER JOIN");
       query.setWhere(null, 0, "TANK_intTankID", "=", intTankKey + "", 0, DALQuery.WHERE_HAS_VALUE);
   ...
   public static boolean unallocateBiospecimenFromTray(int intBiospecimenID, AuthToken authToken)
   {
      ...
      try
      {
         //First check to see if biospecimen is onsite.
    	  int intSiteKey = getSiteKeyforBiospecimen(intBiospecimenID);
   ...
   public static String getInventoryXML(int intBiospecimenKey, AuthToken authToken)
   {
      ...
      Integer intSiteKey = new Integer(InventoryUtilities.getSiteKeyforBiospecimen(intBiospecimenKey));
      ...
      if (authToken.getSiteList().contains(intSiteKey))
    	  strXML.append("<canChangeUnallocInv>1</canChangeUnallocInv>");
      strXML.append("<SITE_strSiteName>" + Utilities.cleanForXSL(strResult[InventoryUtilities.SITENAME]) + "</SITE_strSiteName>");
      strXML.append("<TANK_strTankName>" + Utilities.cleanForXSL(strResult[InventoryUtilities.TANKNAME]) + "</TANK_strTankName>");
      strXML.append("<BOX_strBoxName>" + Utilities.cleanForXSL(strResult[InventoryUtilities.BOXNAME]) + "</BOX_strBoxName>");
      strXML.append("<TRAY_strTrayName>" + Utilities.cleanForXSL(strResult[InventoryUtilities.TRAYNAME]) + "</TRAY_strTrayName>");

...
public class DALQuery {
	...
	static {
		try {
			DISPLAY_DAL_DEBUG = PropertiesManager
					.getPropertyAsBoolean("neuragenix.dao.displayDebug");
		} catch (Exception e) {
			System.out
					.println("[DALQuery] Property neuragenix.dao.displayDebug not present default to false.");
		}
	}
	...
	public DALQuery(DALQuery query) {
		...
		if (query.vtFirstJoinFields != null) {
			...
			for (int i = 0; i < vtFirstJoinFields.size(); i++)
				this.vtFirstJoinFields.set(i, ((Vector) query.vtFirstJoinFields
						.get(i)).clone());
		}
		...
		if (query.vtOrderByDirections != null)
			this.vtOrderByDirections = (Vector) query.vtOrderByDirections
					.clone();
		...
		if (query.vtOrderByFieldsAlias != null)
			this.vtOrderByFieldsAlias = (Vector) query.vtOrderByFieldsAlias
					.clone();
		...
		if (query.vtSecondJoinFields != null) {
			...
			for (int i = 0; i < vtSecondJoinFields.size(); i++)
				this.vtSecondJoinFields.set(i,
						((Vector) query.vtSecondJoinFields.get(i)).clone());
		}
		...
		if (query.vtSiblingQueries != null)
			this.vtSiblingQueryCloseBrackets = (Vector) query.vtSiblingQueryCloseBrackets
					.clone();

		if (query.vtSiblingQueryConnectors != null)
			this.vtSiblingQueryConnectors = (Vector) query.vtSiblingQueryConnectors
					.clone();

		if (query.vtSiblingQueryOpenBrackets != null)
			this.vtSiblingQueryOpenBrackets = (Vector) query.vtSiblingQueryOpenBrackets
					.clone();
		...
		if (query.vtWhereCloseBrackets != null)
			this.vtWhereCloseBrackets = (Vector) query.vtWhereCloseBrackets
					.clone();
		...
		if (query.vtWhereOpenBrackets != null)
			this.vtWhereOpenBrackets = (Vector) query.vtWhereOpenBrackets
					.clone();
		...
		if (query.vtSubQueryFirstJoinFields != null)
			this.vtSubQueryFirstJoinFields = (Vector) query.vtSubQueryFirstJoinFields
					.clone();

		if (query.vtSubQuerySecondJoinFields != null)
			this.vtSubQuerySecondJoinFields = (Vector) query.vtSubQuerySecondJoinFields
					.clone();

		if (query.vtSubQueryJoinTypes != null)
			this.vtSubQueryJoinTypes = (Vector) query.vtSubQueryJoinTypes
					.clone();
	...
	// "DAOQueryInvalidDomain - The domain " + strADomain + " is invalid");
	// throw new DAOQueryInvalidDomain("The domain supplied is invalid");
	// }
	// }
	public void setDomain(String strADomain, String strAField1,
			String strAField2, String strAJoinType)
			throws DAOQueryInvalidDomain {
		if (domainExists(strADomain)) {
			...
			LogService.instance().log(
					LogService.ERROR,
					"DAOQueryInvalidDomain - The domain " + strADomain
							+ " is invalid");
			throw new DAOQueryInvalidDomain("The domain supplied is invalid");
		}
	}
	 ...
	 * Set domain for the query
	 */
	public void setSubQuery(DALQuery qrObject, String strAAlias,
			String strAField1, String strAField2, String strAJoinType)
			throws DAOQueryInvalidDomain {
		if (DatabaseSchema.getDBMSType() != DBMSTypes.ORACLE) {
			...
			LogService.instance().log(LogService.ERROR,
					"This function has not been implemented yet for this DBMS");
			throw new DAOQueryInvalidDomain(
					"This function has not been implemented yet for this DBMS");
		}
	}
	...
	public void setMaxField(String strAField) throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
					"DAOQueryInvalidField - The field supplied is invalid. Field = "
							+ strAField);
			throw new DAOQueryInvalidField(
					"The field supplied is invalid. Field = " + strAField);
		}
	 ...
	 * Set Count function
	 */
	public void setCountField(String strAField, boolean blADistinct)
			throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
					"DAOQueryInvalidField - The field supplied is invalid. Field = "
	 ...
	 */
	public void setOrderBy(String strAField, String strADirection)
			throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
	 ...
	 */
	public void setOrderBy(String strAField, String strADirection,
			boolean blAlias) throws DAOQueryInvalidField {
	 ...
	 */
	public void setSiblingQuery(String strAConnector, DALQuery aQuery,
			int intOpenBrackets, int intCloseBrackets) {
		vtSiblingQueryConnectors.add(strAConnector);
		vtSiblingQueries.add(aQuery);
	 ...
	 * Set fields
	 */
	public void setFields(Vector vtAFieldList, ChannelRuntimeData rdData)
			throws DAOQueryInvalidField {
		if (vtAFieldList == null) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidField - No field supplied");
			throw new DAOQueryInvalidField("No field supplied");
		}

		for (int index = 0; index < vtAFieldList.size(); index++) {
			if (!DatabaseSchema.getFields()
					.containsKey(vtAFieldList.get(index))) {
				LogService.instance().log(
						LogService.ERROR,
						"DAOQueryInvalidField - The field supplied is invalid. Field = "
								+ vtAFieldList.get(index));
				throw new DAOQueryInvalidField(
						"The field supplied is invalid. Field = "
								+ vtAFieldList.get(index));
			}
		}
	 ...
	 */
	public void setFields(Vector vtAFieldList, Hashtable hashData)
			throws DAOQueryInvalidField {
		if (vtAFieldList == null) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidField - No field supplied");
	 ...
	 * Set fields
	 */
	public void setMultiInsert(Vector vtAFieldList,
			ChannelRuntimeData[] rdMultiData) throws DAOQueryInvalidField {
		if (vtAFieldList == null) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidField - No field supplied");
			throw new DAOQueryInvalidField("No field supplied");
		...
		for (int index = 0; index < vtAFieldList.size(); index++) {
			if (!DatabaseSchema.getFields()
					.containsKey(vtAFieldList.get(index))) {
				LogService.instance().log(LogService.ERROR,
						"DAOQueryInvalidField - The field supplied is invalid");
				throw new DAOQueryInvalidField(
						"The field supplied is invalid. Field = "
								+ vtAFieldList.get(index));
			}
	 ...
	 * Set a field
	 */
	public void setField(String strAField, String strAValue)
			throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
		...
		if (!vtFields.contains(strAField))
	 ...
	 * Set a field
	 */
	public void setField(String strAField, String strAValue, String strTarget)
			throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
	 ...
	 * Set WHERE clause
	 */
	public void setWhere(String strAConnector, int intOpenBrackets,
			String strAField, String strAOperator, Object objAObject,
			int intCloseBrackets, int intWhereType) throws DAOQueryInvalidField {
		if (!DatabaseSchema.getFields().containsKey(strAField)) {
			LogService.instance().log(
					LogService.ERROR,
					"DAOQueryInvalidField - The field supplied is invalid. Field = "
	 ...
	 * 
	 * @param strInitialConnector
	 *            Connector for the first field in the set
	 * @param strGroupConnector
	 *            Connector for field_2 to field_n
	 * @param intOpenBrackets
	 *            Open brackets will start for the first field only
	 * @param intCloseBrackets
	 *            Close brackets are applied to the last field
	 * @param intWhereType
	 *            Where type is constant for all fields
	 * @param vtFields
	 *            Form fields that the function should be interested in
	 * @param runtimeData
	 *            Channel runtime data for the fields
	 * 
	 */

	public void setWhereMultiField(String strInitialConnector,
			String strGroupConnector, int intOpenBrackets, String strAOperator,
			int intCloseBrackets, int intWhereType, Vector vtFields,
		...
		if (vtFields != null && vtFields.size() > 0) {
			for (int i = 0; i < vtFields.size(); i++) {
				...
				String strComparisonValue = runtimeData
						.getParameter(strFieldName);
				...
				if (strComparisonValue != null) {
					...
					} else if (intFieldCount == 0) // plugging the first field
													// in
					{
						strConnector = strInitialConnector;
						openBracket = intOpenBrackets;
					...
					this.setWhere(strConnector, openBracket, strFieldName,
							strAOperator, strComparisonValue, closeBracket,
							intWhereType);
					intFieldCount++;
				}
			}
	 ...
	 *            Connector for field_2 to field_n
	 * @param strAOperator
	 *            Operator that will be applied to all fields
	 * @param intOpenBrackets
	 *            Open brackets will start for the first field only
	 * @param intCloseBrackets
	 *            Close brackets are applied to the last field
	 ...
	 *            Where type is constant for all fields
	 * @param htFields
	 *            Hashtable of fields and data
	 * 
	 */

	public void setWhereMultiField(String strInitialConnector,
			String strGroupConnector, int intOpenBrackets, String strAOperator,
			int intCloseBrackets, int intWhereType, Hashtable htFields)
			throws DAOQueryInvalidField {
		int intFieldCount = 0;
	 ...
	 */
	public String convertSelectQueryToString() throws DAOQueryInvalidDomain,
			DAOQueryInvalidField, DBMSInvalidOperator {
		// must have at least one domain for the query
		if (vtDomains.size() < 1) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidDomain - No domain supplied");
		...
		for (int index = 0; index < vtMaxFields.size(); index++) {
			...
			DBField fieldTemp = (DBField) DatabaseSchema.getFields().get(
					strFieldName);

			strResult.append("MAX("
					+ fieldTemp.getExternalName()
					+ ") AS "
					+ DBMSTypes.getField("MAX_"
							+ fieldTemp.getShortInternalName()) + ", ");
		}
		...
		for (int index = 0; index < vtMinFields.size(); index++) {
			...
			strResult.append("MIN("
					+ fieldTemp.getExternalName()
					+ ") AS "
					+ DBMSTypes.getField("MIN_"
							+ fieldTemp.getShortInternalName()) + ", ");
		}
		...
		for (int index = 0; index < vtAverageFields.size(); index++) {
			...
			strResult.append("AVG("
					+ fieldTemp.getExternalName()
					+ ") AS "
					+ DBMSTypes.getField("AVG_"
							+ fieldTemp.getShortInternalName()) + ", ");
		}
		...
		for (int index = 0; index < vtSumFields.size(); index++) {
			...
			strResult.append("SUM("
					+ fieldTemp.getExternalName()
					+ ") AS "
					+ DBMSTypes.getField("SUM_"
							+ fieldTemp.getShortInternalName()) + ", ");
		}
			...
			if (strCountField.equals("*")) {
				...
				if (blCountDistinct)
					if (DatabaseSchema.getDBMSType() == DBMSTypes.SQLSERVER)
						strResult.append("COUNT(DISTINCT ("
								+ fieldTemp.getExternalName()
								+ ")) AS "
								+ DBMSTypes.getField("COUNT_"
										+ fieldTemp.getShortInternalName())
								+ ", ");
					else
						strResult.append("COUNT(DISTINCT "
		...
		if (vtFields != null) {
			for (int index = 0; index < vtFields.size(); index++) {
				...
				if (strDistinctField != null
						&& strDistinctField.equals(strFieldName))
					if (DatabaseSchema.getDBMSType() == DBMSTypes.SQLSERVER)
						strResult.append("DISTINCT ("
								+ fieldTemp.getExternalName() + ") AS "
								+ fieldTemp.getShortInternalName() + ", ");
					else
						strResult.append("DISTINCT "
								+ fieldTemp.getExternalName() + " AS "
					...
					strResult.append(fieldTemp.getExternalName()
							+ " AS "
							+ DBMSTypes.getField(fieldTemp
									.getShortInternalName()) + ", ");
			}
			strResult = new StringBuffer(strResult.substring(0, strResult
					.length() - 2)
					+ " FROM ");
		} else
			strResult = new StringBuffer(strResult.substring(0, strResult
		...
		String strFirstDomainName = (String) DatabaseSchema.getDomains().get(
				vtDomains.get(0));
		...
		for (int index = 1; index < vtDomains.size(); index++) {
			...
			String strPrevDomainName = (String) DatabaseSchema.getDomains()
					.get(vtDomains.get(index - 1));

			String strDomainName = (String) DatabaseSchema.getDomains().get(
					vtDomains.get(index));
...

			{
				...
				for (int i = 0; i < joinFields1.size(); i++) {
					DBField firstJoinField = (DBField) DatabaseSchema
							.getFields().get(joinFields1.get(i));
					DBField secondJoinField = (DBField) DatabaseSchema
							.getFields().get(joinFields2.get(i));
					...
					// -System.err.println("'"+DatabaseSchema.secondJoinField.getDomain()
					// + "'\t'" +firstJoinField.getDomain() + "'=" +
					// strPrevDomainName );
					String firstJoinFieldDomain = (String) DatabaseSchema
							.getDomains().get(firstJoinField.getDomain());
					String secondJoinFieldDomain = (String) DatabaseSchema
							.getDomains().get(secondJoinField.getDomain());
					List subList = vtDomains.subList(0, index);
					boolean previouslyCovered = subList.contains(firstJoinField
							.getDomain())
							|| subList.contains(secondJoinField.getDomain());
					if (firstJoinFieldDomain.equals(strPrevDomainName)
							|| secondJoinFieldDomain.equals(strPrevDomainName)
							|| previouslyCovered) {

						if (setFirstDomainClause == false) {
							strResult.append(DBMSTypes.getOperator(strJoinType)
									+ strDomainName + " ON "
									+ firstJoinField.getExternalName() + " = "
									+ secondJoinField.getExternalName());
						...
						vtLeftovers.add(firstJoinField.getExternalName()
								+ " = " + secondJoinField.getExternalName());
				...
				// DBField firstJoinField = (DBField)
				// DatabaseSchema.getFields().get(vtFirstJoinFields.get(index));
				// DBField secondJoinField = (DBField)
				// DatabaseSchema.getFields().get(vtSecondJoinFields.get(index));

				// strResult.append(DBMSTypes.getOperator(strJoinType) +
				// strDomainName + " ON " + firstJoinField.getExternalName() +
				// " = " + secondJoinField.getExternalName());
			}
		}
		...
		for (int index = 0; index < vtSubQueries.size(); index++) {
			...
			if (strJoinType == null) {
				strResult.append(", (" + qrObject.convertSelectQueryToString()
						+ ") AS " + strAlias);
			} else {
				DBField firstJoinField = (DBField) DatabaseSchema.getFields()
						.get(vtSubQueryFirstJoinFields.get(index));
				DBField secondJoinField = (DBField) DatabaseSchema.getFields()
						.get(vtSubQuerySecondJoinFields.get(index));

				strResult.append(DBMSTypes.getOperator(strJoinType) + "("
						+ qrObject.convertSubSelectQueryToString() + ") AS "
						+ strAlias + " ON " + firstJoinField.getExternalName()
						+ " = " + secondJoinField.getExternalName());
			}
		}
		...
		for (int index = 0; index < vtWhereTypes.size(); index++) {
			...
			case WHERE_HAS_VALUE:
				intOpenBrackets = ((Integer) vtWhereOpenBrackets.get(index))
						.intValue();
				intCloseBrackets = ((Integer) vtWhereCloseBrackets.get(index))
						.intValue();
				strWhereConnector = (String) vtWhereConnectors.get(index);
				strWhereOperator = (String) vtWhereOperators.get(index);
				firstWhereField = (DBField) DatabaseSchema.getFields().get(
						vtWhereFields.get(index));
				...
				if (strWhereOperator.equals("LIKE")) {
					if (!blCaseSensitiveOn && intDataType == DBMSTypes.STR_TYPE)
						strResult.append(DBMSTypes.lower(firstWhereField
								.getExternalName())
								+ " LIKE '%"
								+ DBMSTypes.cleanDataForQuery(data
										.toLowerCase()) + "%'");

					else
						strResult.append(firstWhereField.getExternalName()
								+ " LIKE '%"
								+ DBMSTypes.cleanDataForQuery(data) + "%'");
					...
					if (!blCaseSensitiveOn && intDataType == DBMSTypes.STR_TYPE)
						...
						strResult.append(firstWhereField.getExternalName()
								+ " LIKE '" + DBMSTypes.cleanDataForQuery(data)
								+ "%'");
					...
					if (!blCaseSensitiveOn && intDataType == DBMSTypes.STR_TYPE)
						strResult.append(DBMSTypes.lower(firstWhereField
								.getExternalName())
								+ DBMSTypes.getOperator(strWhereOperator));
					else
						strResult.append(firstWhereField.getExternalName()
								+ DBMSTypes.getOperator(strWhereOperator));
					...
					case DBMSTypes.DATE_TYPE:
						strResult.append(DBMSTypes.convertToString(Utilities
								.convertDateForQuery(data)));
						break;

					// Data is time
					case DBMSTypes.TIME_TYPE:
						strResult.append(DBMSTypes.convertToTime(Utilities
								.convertTimeForQuery(data)));
						break;

					// Data is string
					case DBMSTypes.STR_TYPE:
						// if data is longer than the max allowable length, need
						// truncation
			...
			case WHERE_BOTH_FIELDS:
				...
				firstWhereField = (DBField) DatabaseSchema.getFields().get(
						vtWhereFields.get(index));
				secondWhereField = (DBField) DatabaseSchema.getFields().get(
						vtWhereObjects.get(index));
				...
				strResult.append(firstWhereField.getExternalName()
						+ DBMSTypes.getOperator(strWhereOperator)
						+ secondWhereField.getExternalName());
			...
			case WHERE_HAS_NULL_VALUE:
				...
				strResult.append(firstWhereField.getExternalName()
						+ DBMSTypes.getOperator(strWhereValue));
		...
		for (int index = 0; index < vtSiblingQueries.size(); index++) {
			int intOpenBrackets = ((Integer) vtSiblingQueryOpenBrackets
					.get(index)).intValue();
			int intCloseBrackets = ((Integer) vtSiblingQueryCloseBrackets
					.get(index)).intValue();
				...
				if (!vtSiblingQueryConnectors.get(index).equals("UNION")) {
					if (vtWhereFields.size() > 0 || vtLeftovers.size() > 0) {
						strResult
								.append(" AND "
										+ DBMSTypes
												.getOperator((String) vtSiblingQueryConnectors
														.get(index)) + " (");
					} else {
						strResult
								.append(" WHERE "
			...
			strResult.append(((DALQuery) vtSiblingQueries.get(index))
					.convertSelectQueryToString());
		...
		for (int index = 0; index < vtGroupByFields.size(); index++) {
			DBField groupbyField = (DBField) DatabaseSchema.getFields().get(
					vtGroupByFields.get(index));
			if (index < 1)
		...
		// add ORDER BY
		// Check if both vtOrderByFieldsAlias & vtOrderByFields is defined, if
		// so throw error
		if (vtOrderByFieldsAlias.isEmpty() == false
				&& vtOrderByFields.isEmpty() == false) {

			System.err
					.println("Unknown error while trying to execute the SELECT: [DALQuery Error] - Invalid orderby defined.");
			LogService
					.instance()
					.log(
							LogService.ERROR,
							"Unknown error while trying to execute the SELECT: [DALQuery Error] - Invalid orderby defined.");
		...
		if (vtOrderByFieldsAlias.isEmpty() == true) {
			...
			for (int index = 0; index < vtOrderByFields.size(); index++) {
				DBField orderbyField = (DBField) DatabaseSchema.getFields()
						.get(vtOrderByFields.get(index));
				if (index < 1)
					strResult.append(" ORDER BY "
							+ orderbyField.getExternalName() + " "
							+ vtOrderByDirections.get(index));
				else
					strResult.append(", " + orderbyField.getExternalName()
							+ " " + vtOrderByDirections.get(index));
			}
			...
			for (int index = 0; index < vtOrderByFieldsAlias.size(); index++) {
				...
				if (index < 1)
					strResult.append(" ORDER BY "
							+ DBMSTypes.getAlias(strAlias) + " "
							+ vtOrderByDirections.get(index));
				else
					strResult.append(", " + DBMSTypes.getAlias(strAlias) + " "
							+ vtOrderByDirections.get(index));
			}
		...
		if (!vtOrderBySqlFunctions.isEmpty()) {
			...
			// "ORDER BY FUNCTION INSIDE");
			for (int index = 0; index < vtOrderBySqlFunctions.size(); index++) {

				if (index < 1)
					strResult.append(" ORDER BY "
							+ vtOrderBySqlFunctions.get(index).toString() + " "
							+ vtOrderByDirectionFunction.get(index));
				else
					strResult.append(", "
							+ vtOrderBySqlFunctions.get(index).toString() + " "
							+ vtOrderByDirectionFunction.get(index));
	 ...
	 */
	public String convertSubSelectQueryToString() throws DAOQueryInvalidDomain,
			DAOQueryInvalidField, DBMSInvalidOperator {
		// must have at least one domain for the query
		if (vtDomains.size() < 1) {
			LogService.instance().log(LogService.ERROR,
		...
		for (int index = 0; index < vtSiblingQueries.size(); index++) {
			...
			strResult.append(DBMSTypes
					.getOperator((String) vtSiblingQueryConnectors.get(index)));
			// add open brackets
			for (int i = 0; i < intOpenBrackets; i++) {
				strResult.append("(");
			}
	...
	public ResultSet executeSelect() throws DAOException {
		try {
			...
			if (authToken != null) {
				DALLoggerRepository.addLog("SELECT", strSQLSelect, vtFields,
						null, authToken);
			}
			...
			ps = con.prepareStatement(strSQLSelect,
			...
			throw new DAOException(
					"Unknown error while trying to execute the SELECT: "
							+ e.toString());
		}
	}
		...
		try {
						...
						try {
							...
							if (DISPLAY_DAL_DEBUG) {
								LogService
										...
										.log(
												LogService.ERROR,
												"[DALQuery] Warning - Unable to release database connection",
												e);
								System.err
										.println("[DALQuery] Warning - Unable to close ResultSet");
			...
			if (DISPLAY_DAL_DEBUG) {
				LogService
						...
						.log(
								LogService.ERROR,
								"[DALQuery] - Unexpected error when destroying connections",
								e);
				System.err
						.println("[DALQuery] - Unexpected error when destroying connections");
				e.printStackTrace(System.err);
			}
		} finally {
			try {
				...
				if (DISPLAY_DAL_DEBUG) {
					LogService
							...
							.log(
									...
									rc);
					System.err
							.println("[DALQuery] Warning - Unable to release database connection");
	 ...
	 */
	public boolean executeUpdate() throws DAOException, DAOUpdateInvalidDomain,
			DBMSInvalidOperator {
		...
		if (vtDomains.size() < 1 || vtDomains.size() > 1) {
			...
			LogService
					...
					.log(
							LogService.ERROR,
							"DAOUpdateInvalidDomain - The number of domains specified is invalid. Only one allowed!");
			throw new DAOUpdateInvalidDomain(
					"The number of domains specified is invalid. Only one allowed!");
		}

		// must have at least one field
		if (vtFields == null || vtFields.size() < 1) {
			LogService.instance().log(LogService.ERROR,
					"DAOException - No field supplied");
		...
		if (rdFieldData == null && hashFieldData == null) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidField - No runtime/hash data supplied");
			throw new DAOQueryInvalidField("No runtime/hash data supplied");
		}

		try {
			StringBuffer strSQLUpdate = new StringBuffer("UPDATE "
					+ DatabaseSchema.getDomains().get(vtDomains.get(0))
					+ " SET ");

			String strPrimaryKey = null;
			// for Oracle we need to add primary key field
			if (DatabaseSchema.getDBMSType() == DBMSTypes.ORACLE) {
				strPrimaryKey = DatabaseSchema.getPrimaryKey((String) vtDomains
						.get(0));
			}
			...
			for (int index = 0; index < vtFields.size(); index++) {
				...
				if (fieldTemp.getDataType() == DBMSTypes.CLOB_TYPE
						&& DatabaseSchema.getDBMSType() == DBMSTypes.ORACLE) {
					...
					strSQLUpdate
							.append(fieldTemp.getNameForUpdate() + " = ?, ");
				}
			}
			strSQLUpdate = new StringBuffer(strSQLUpdate.substring(0,
					strSQLUpdate.length() - 2));
			...
			for (int index = 0; index < vtWhereTypes.size(); index++) {
				...
				int intWhereType = ((Integer) vtWhereTypes.get(index))
						.intValue();
				switch (intWhereType) {
				case WHERE_HAS_VALUE:
					intOpenBrackets = ((Integer) vtWhereOpenBrackets.get(index))
							.intValue();
					intCloseBrackets = ((Integer) vtWhereCloseBrackets
							.get(index)).intValue();
					strWhereConnector = (String) vtWhereConnectors.get(index);
					strWhereOperator = (String) vtWhereOperators.get(index);
					firstWhereField = (DBField) DatabaseSchema.getFields().get(
					...
					if (strWhereConnector != null) {
						...
						strSQLUpdate.append(DBMSTypes
								.getOperator(strWhereConnector));
					}
					...
					if (strWhereOperator.equals("LIKE")) {
						if (!blCaseSensitiveOn
							...
							strSQLUpdate.append(DBMSTypes.lower(firstWhereField
									.getExternalName())
									+ " LIKE '%"
									+ DBMSTypes.cleanDataForQuery(data
											.toLowerCase()) + "%'");
							...
							strSQLUpdate.append(firstWhereField
									.getExternalName()
									+ " LIKE '%"
									+ DBMSTypes.cleanDataForQuery(data) + "%'");

						}
						// strSQLUpdate.append(firstWhereField.getExternalName()
						// + " LIKE '%" + data + "%'");
					} else if (strWhereOperator.equals("LEFT LIKE")) {
						if (!blCaseSensitiveOn
								&& intDataType == DBMSTypes.STR_TYPE) {
						...
						case DBMSTypes.TIME_TYPE:
							strSQLUpdate.append(DBMSTypes
									.convertToTime(Utilities
											.convertTimeForQuery(data)));
							break;

						// Data is string
						case DBMSTypes.STR_TYPE:
							// if data is longer than the max allowable length,
							// need truncation
							if (data.length() > intMaxDataLength)
								data = data.substring(0, intMaxDataLength);
							...
							strSQLUpdate
									.append(DBMSTypes.convertToString(data));
							break;

						// Data is duration
						case DBMSTypes.DURATION_TYPE:
							strSQLUpdate.append(DBMSTypes
									.convertToNumeric(Utilities
											.convertDurationForDB(data)));
							break;
				...
				case WHERE_BOTH_FIELDS:
					...
					firstWhereField = (DBField) DatabaseSchema.getFields().get(
							vtWhereFields.get(index));
					secondWhereField = (DBField) DatabaseSchema.getFields()
							.get(vtWhereObjects.get(index));
				...
				case WHERE_HAS_SUB_QUERY:
					...
					if (vtWhereFields.get(index) == null)
						strSQLUpdate.append(DBMSTypes
								.getOperator(strWhereOperator));
					else {
						firstWhereField = (DBField) DatabaseSchema.getFields()
								.get(vtWhereFields.get(index));
						strSQLUpdate.append(firstWhereField.getExternalName()
								+ DBMSTypes.getOperator(strWhereOperator));
					}
					...
					// add sub-query recursively
					strSQLUpdate.append("("
							+ sub_query.convertSelectQueryToString() + ")");
			...
			for (int index = 0; index < vtFields.size(); index++) {
				...
				if (data == null || data.trim().length() == 0) {
					...
					// Data is date
					case DBMSTypes.DATE_TYPE:
						ps.setDate(psIndex + 1, java.sql.Date.valueOf(Utilities
								.convertDateForDB(data)));
						psIndex++;
						break;

					// Data is time
					case DBMSTypes.TIME_TYPE:
						ps.setTime(psIndex + 1, java.sql.Time.valueOf(Utilities
								.convertTimeForDB(data)));
						psIndex++;
						break;
					...
					case DBMSTypes.STR_TYPE:
						...
						if (ps instanceof oracle.jdbc.OraclePreparedStatement) {
							...
							if (ps instanceof com.codestudio.sql.PoolManPreparedStatement) {
								PreparedStatement psTemp = ((com.codestudio.sql.PoolManPreparedStatement) ps)
										.getNativePreparedStatement();
								if (psTemp instanceof oracle.jdbc.OraclePreparedStatement) {
									((oracle.jdbc.OraclePreparedStatement) psTemp)
											.setFormOfUse(
													index + 1,
													oracle.jdbc.OraclePreparedStatement.FORM_NCHAR);
								}
					...
					// Data is duration
					case DBMSTypes.DURATION_TYPE:
						ps.setInt(psIndex + 1, Integer.parseInt(Utilities
								.convertDurationForDB(data)));
						psIndex++;
						break;
			...
			// request a log if authToken exists
			if (authToken != null) {
				DALLoggerRepository.addLog("UPDATE", strSQLUpdate.toString(),
						vtFields, rdFieldData, authToken);
			}
			...
			if (intUpdateResult == 0) {
				...
				if (vtCLOB.size() > 0) {
					...
					strUpdateClob = new StringBuffer(strUpdateClob.substring(0,
							strUpdateClob.length() - 2));
					strUpdateClob
							.append(" FROM "
									+ DatabaseSchema.getDomains().get(
											vtDomains.get(0)));
					strUpdateClob.append(" " + strWhereString + " FOR UPDATE");

					PreparedStatement psUpdateClob = con
							.prepareStatement(strUpdateClob.toString());
					...
					if (rsUpdateClob.next()) {
						...
						for (int i = 0; i < vtCLOB.size(); i++) {
							...
							if (rdFieldData
									.getParameter((String) vtCLOBFieldname
											.get(i)) != null
									&& rdFieldData.getParameter(
											(String) vtCLOBFieldname.get(i))
											.trim().length() > 0) {
								oracle.sql.CLOB clob = (oracle.sql.CLOB) rsUpdateClob
										.getClob(i + 1);
								Writer wtClob = clob.getCharacterOutputStream();
								wtClob.write(rdFieldData
										.getParameter((String) vtCLOBFieldname
												.get(i)));
								wtClob.flush();
								wtClob.close();
			...
			LogService.instance().log(LogService.ERROR, e.toString());
			throw new DAOException(
					"Unknown error while trying to execute the UPDATE: "
							+ e.toString());
		}
		return blUpdateOK;
	}
	 ...
	 */
	public boolean executeInsert() throws DAOException, DAOUpdateInvalidDomain,
			DBMSInvalidOperator {
		...
		try {
			StringBuffer strSQLInsert = new StringBuffer("INSERT INTO "
					+ DatabaseSchema.getDomains().get(vtDomains.get(0)) + " (");
			...
			for (int index = 0; index < vtFields.size(); index++) {
				// Long change to obmit 'null' value in runtimeData to be
				// inserted
				if ((rdFieldData.getParameter((String) vtFields.get(index)) != null)
						&& (!rdFieldData.getParameter(
								(String) vtFields.get(index)).trim().equals(""))) {

					DBField fieldTemp = (DBField) DatabaseSchema.getFields()
							.get(vtFields.get(index));
			...
			// cut the last comma
			strSQLInsert = new StringBuffer(strSQLInsert.substring(0,
					strSQLInsert.length() - 2)
					+ ") VALUES (");

			// for Oracle we need to add primary key field
			if (DatabaseSchema.getDBMSType() == DBMSTypes.ORACLE) {
				if (strPrimaryKey != null) {
					strSQLInsert.append(DatabaseSchema
							.getSequence((String) vtDomains.get(0))
							+ ".NEXTVAL, ");
				}
			}
			...
			for (int index = 0; index < vtFields.size(); index++) {
				...
				if (data == null || data.trim().equals("")) {
					/*
					 * switch (intDataType) { // Data is integer case
					 * DBMSTypes.INT_TYPE: ps.setNull(index + 1, Types.INTEGER);
					 * break;
					 * 
					 * // Data is floating point case DBMSTypes.FLOAT_TYPE:
					 * ps.setNull(index + 1, Types.FLOAT); break;
					 * 
					 * // Data is double case DBMSTypes.DOUBLE_TYPE:
					 * ps.setNull(index + 1, Types.DOUBLE); break;
					 * 
					 * // Data is date case DBMSTypes.DATE_TYPE:
					 * ps.setNull(index + 1, Types.DATE); break;
					 * 
					 * // Data is string case DBMSTypes.STR_TYPE:
					 * ps.setNull(index + 1, Types.VARCHAR); break; }
					 */
				} else {
					switch (intDataType) {
					// Data is integer
			...
			// request a log if authToken exists
			if (authToken != null) {
				DALLoggerRepository.addLog("INSERT", strSQLInsert.toString(),
						vtFields, rdFieldData, authToken);
			}
			...
			if (intInsertResult == 0) {
				...
				String strSelectInsertedKey = DBMSTypes
						.getQueryToGetInsertedRecordKey((String) vtDomains
								.get(0));
				if (strSelectInsertedKey != null) {
					PreparedStatement psSelect = con
							.prepareStatement(strSelectInsertedKey);
				...
				if (vtCLOB.size() > 0) {
					...
					strUpdateClob
							.append(" FROM "
									+ DatabaseSchema.getDomains().get(
											vtDomains.get(0)));
					strUpdateClob.append(" WHERE " + strPrimaryKey + " = "
							+ intInsertedRecordKey + " FOR UPDATE");
			...
			throw new DAOException(
					"Unknown error while trying to execute the INSERT: "
							+ e.toString(), e);
		}
	 ...
	 */
	public boolean executeMultiInsert() throws DAOException,
			DAOUpdateInvalidDomain, DBMSInvalidOperator {
		boolean blInsertOK = true;
		...
		if (rdMultiData == null) {
			LogService.instance().log(LogService.ERROR,
					"DAOQueryInvalidField - No runtime data supplied");
		...
		try {
			...
			for (int i = 0; i < rdMultiData.length; i++) {
				...
				for (int index = 0; index < vtFields.size(); index++) {
					...
					int intDataType = fieldTemp.getDataType();
					int intMaxDataLength = fieldTemp.getLength();
					String data = rdMultiData[i].getParameter((String) vtFields
							.get(index));
					...
					if (data == null) {
						...
						// Data is date
						case DBMSTypes.DATE_TYPE:
							ps.setDate(index + 1, java.sql.Date
									.valueOf(Utilities.convertDateForDB(data)));
							break;

						// Data is time
						case DBMSTypes.TIME_TYPE:
							ps.setTime(index + 1, java.sql.Time
									.valueOf(Utilities.convertTimeForDB(data)));
							break;
			...
			LogService.instance().log(LogService.ERROR, e.toString());
			throw new DAOException(
					"Unknown error while trying to execute the MULTI INSERT: "
							+ e.toString());
		}
	 ...
	 */
	public boolean executeDelete() throws DAOException, DAOUpdateInvalidDomain,
			DBMSInvalidOperator {
		...
		try {
			StringBuffer strSQLDelete = new StringBuffer("DELETE FROM "
					+ DatabaseSchema.getDomains().get(vtDomains.get(0)));
			...
			for (int index = 0; index < vtWhereTypes.size(); index++) {
				...
				case WHERE_HAS_VALUE:
					...
					// add fields and operator
					if (strWhereOperator.equals("LIKE")) {
						strSQLDelete.append(firstWhereField.getExternalName()
								+ " LIKE '%" + data + "%'");
					} else if (strWhereOperator.equals("LEFT LIKE")) {
						strSQLDelete.append(firstWhereField.getExternalName()
								+ " LIKE '" + data + "%'");
			...
			LogService.instance().log(LogService.ERROR, e.toString());
			throw new DAOException(
					"Unknown error while trying to execute the DELETE: "
							+ e.toString());
		}
		return blDeleteOK;
	}
	...
	public void commitTransaction() throws DAOException {
		try {
			...
			LogService.instance().log(LogService.ERROR, e.toString());
			throw new DAOException(
					"Unknown problem occured while trying to commit the database transactions.");
		}
	}
	...
	public void cancelTransaction() throws DAOException {
		try {
			...
			LogService.instance().log(LogService.ERROR, e.toString());
			throw new DAOException(
					"Unknown problem occured while trying to cancel the database transactions.");
		}
	}
	...
	private void transferHashtableToRuntimeData() {
		...
		while (enumFieldData.hasMoreElements()) {
			...
			String strFieldDataValue = (String) hashFieldData
					.get(strFieldDataKey);
			DBField dbField = (DBField) DatabaseSchema.getFields().get(
					strFieldDataKey);

			if (dbField != null && dbField.getDataType() == DBMSTypes.TIME_TYPE) {

				// check if value is already in the format of HH:MM AM
				if (strFieldDataValue != null
						&& strFieldDataValue
								.matches("^[01]?[0-9]:[0-9][0-9] [aApP][mM]$")) {
					rdFieldData
							.setParameter(strFieldDataKey, strFieldDataValue);
				}
				// if not, convert it
				else {
					rdFieldData.setParameter(strFieldDataKey, Utilities
							.convertTimeForDisplay(strFieldDataValue));
				}
	 ...
	 * Set distinct field
	 */
	public void setDistinctField(String strDistinctField)
			throws DAOQueryInvalidField {
		...
		if (!blManualCommit) {
			try {
				...
				throw new java.sql.SQLException(
						"Unknown error while trying to release the connection: "
								+ e.toString());
			}
		}
	}

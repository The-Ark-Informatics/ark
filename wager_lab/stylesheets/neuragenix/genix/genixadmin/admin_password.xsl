...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
    ...
    <xsl:template match="admin_password">
	...
	<xsl:param name="strUsername"><xsl:value-of select="strUsername" /></xsl:param>
        ...
        <xsl:param name="PERSON_DIR_Timestamp"><xsl:value-of select="PERSON_DIR_Timestamp" /></xsl:param>
...
<!--          <tr>
          ...
          <tr>    
            ...
            <td class="uportal-label" id="neuragenix-form-row-input">
                <input type="hidden" name="PERSON_DIR_Timestamp" value="{$strNewPassword2}"  />

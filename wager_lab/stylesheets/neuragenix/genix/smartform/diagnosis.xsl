...
<xsl:template match='diagnosis_picker'>
			...
			Choose diagnosis<br/><hr/>
                ...
                <tr>
                    ...
                    <xsl:for-each select="diagnosis">
                        ...
                        <xsl:variable name="DIAGNOSIS_strDiagnosisName"><xsl:value-of select="normalize-space(DIAGNOSIS_strDiagnosisName)"/></xsl:variable>
                        <xsl:variable name="DIAGNOSIS_strEPCCCode"><xsl:value-of select="normalize-space(DIAGNOSIS_strEPCCCode)"/></xsl:variable>
